...
Automate the deployment and management of Google Cloud Dedicated infrastructure resources using Terraform.
...
#### [
Terraform on Google Cloud Dedicated
](/docs/terraform)


Define Google Cloud Dedicated resources in human-readable configuration files that you can version, reuse, and share.
...
Configure Google Cloud Dedicated services and resources using Kubernetes tooling and APIs.
...
Configure Terraform to define and provision Google Cloud Dedicated infrastructure and use your existing toolchain for tasks such as testing and dependency management.[ open_in_new ](https://developer.hashicorp.com/terraform/cdktf)
...
#### [
Google Cloud Dedicated provider for Pulumi
