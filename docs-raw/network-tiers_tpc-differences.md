# Network Service Tiers in Google Cloud Dedicated versus Google Cloud

Source: https://berlin.devsitetest.how/network-tiers/docs/tpc-differences
...
](https://berlin.devsitetest.how/network-tiers/docs/overview)
...
Network Service Tiers lets you optimize connectivity between systems on the
internet and your Google Cloud Dedicated in Germany instances.
This page describes the differences between the
Google Cloud Dedicated and Google Cloud versions of Network Service Tiers.



For more detailed information about Network Service Tiers, see the
[Network Service Tiers overview](/network-tiers/docs/overview) and the rest of the
...
There are some differences between the Google Cloud Dedicated version of Network Service Tiers and
...
If you would like to use a particular Network Service Tiers feature that isn't currently
...
**Standard Tier**
| 
Trusted Cloud has only a single region, though with multiple zones. This
means that Standard Tier isn't available. Only Premium Tier is available
for Google Cloud Dedicated in Germany.
| 
|
...
The following information might also affect how you use and design for Network Service Tiers
