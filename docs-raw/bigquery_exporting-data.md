...
gcsRef := bigquery . [ NewGCSReference ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_GCSReference_NewGCSReference) ( gcsURI ) 
gcsRef . FieldDelimiter = "," 

extractor := client . [ DatasetInProject ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Client_DatasetInProject) ( srcProject , srcDataset ). Table ( srcTable ). ExtractorTo ( gcsRef ) 
extractor . DisableHeader = true 
// You can choose to run the job in a specific location for more complex data locality scenarios. 
// Ex: In this example, source dataset and GCS bucket are in the US. 
extractor . [ Location ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Job_Location) = "US" 
...
```
import com.google.cloud.[RetryOption](https://berlin.devsitetest.how/java/docs/reference/google-cloud-core/latest/com.google.cloud.RetryOption.html) ; 
...
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) projectId = "bigquery-public-data" ; 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) datasetName = "samples" ; 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) tableName = "shakespeare" ; 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) bucketName = "my-bucket" ; 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) destinationUri = "gs://" + bucketName + "/path/to/file" ; 
// For more information on export formats available see: 
// https://cloud.google.com/bigquery/docs/exporting-data#export_formats_and_compression_types 
// For more information on Job see: 
// https://googleapis.dev/java/google-cloud-clients/latest/index.html?com/google/cloud/bigquery/package-summary.html 

[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) dataFormat = "CSV" ; 
...
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) projectId , 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) datasetName , 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) tableName , 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) destinationUri , 
[ String ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) dataFormat ) { 
try { 
...
return ; 
} else if ( completedJob . [ getStatus ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.Job.html#com_google_cloud_batch_v1_Job_getStatus__) (). getError () != null ) { 
System . out . println ( 
"BigQuery was unable to extract due to an error: \n" + job . [ getStatus ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-batch/latest/com.google.cloud.batch.v1.Job.html#com_google_cloud_batch_v1_Job_getStatus__) (). getError ()); 
return ; 
} 
System . out . println ( 
...
You can export your query results to Cloud Storage in the Google Cloud Dedicated console
...
gcsRef := bigquery . [ NewGCSReference ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_GCSReference_NewGCSReference) ( gcsURI ) 
gcsRef . [ Compression ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Compression) = bigquery . [ Gzip ](https://berlin.devsitetest.how/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_None_Gzip_Deflate_Snappy)
...
import com.google.cloud.bigquery.[BigQueryException](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryException.html) ; 
import com.google.cloud.bigquery.[BigQueryOptions](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryOptions.html) ; 
import com.google.cloud.bigquery.[ExtractJobConfiguration](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.ExtractJobConfiguration.html) ; 
import com.google.cloud.bigquery.[Job](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Job.html) ; 
...
[ TableId ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) tableId = [ TableId ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) . of ( projectName , datasetName , tableName ); 

[ ExtractJobConfiguration ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.ExtractJobConfiguration.html) extractConfig = 
[ ExtractJobConfiguration ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.ExtractJobConfiguration.html) . newBuilder ( tableId , destinationUri ) 
. setCompression ( compressed ) 
. [ setFormat ](https://berlin.devsitetest.how/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.ExtractJobConfiguration.Builder.html#com_google_cloud_bigquery_ExtractJobConfiguration_Builder_setFormat_java_lang_String_) ( dataFormat ) 
. build (); 
...
[Go to **Alerting**](https://console.cloud.berlin-build0.goog/monitoring/alerting)
...
For information on data export pricing, see the [BigQuery pricing](https://berlin.devsitetest.how/bigquery/pricing#data_extraction_pricing) page.

Once the data is exported, you are charged for storing the data in
Cloud Storage. For more information,
see [Cloud Storage pricing](https://berlin.devsitetest.how/storage/pricing).
...
[Using the Google Cloud Dedicated console](/bigquery/docs/bigquery-web-ui).
