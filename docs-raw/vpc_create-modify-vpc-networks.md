...
resources](/vpc/docs/subnets#vpc_networks_and_subnets) in Google Cloud Dedicated.
...
Google Cloud Dedicated for a specific use case. You only need to configure a network
...
network, one [subnet](/vpc/docs/subnets) is created in each Google Cloud Dedicated
...
In the Google Cloud Dedicated console, go to the **VPC networks** page.

[Go to VPC networks](https://console.cloud.berlin-build0.goog/networking/networks/list) 
...
```
POST https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks
{
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks
```
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks/ NETWORK 
```
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /aggregated/subnetworks
```
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks
```
...
- ` REGION `: the name of the Google Cloud Dedicated region
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks/ SUBNET 
```
...
- ` REGION `: the name of the Google Cloud Dedicated
...
```
GET https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks/ SUBNET ?views=WITH_UTILIZATION
```
...
- ` REGION `: the Google Cloud Dedicated region in which the
...
```
POST https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks
{
...
- ` REGION `: the name of the Google Cloud Dedicated region where
the subnet is added.
...
- ` REGION `: the subnet's Google Cloud Dedicated region
...
```
DELETE https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks/ SUBNET 
```
...
- ` REGION `: the name of the Google Cloud Dedicated region that
...
```
POST https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /regions/ REGION /subnetworks/ SUBNET /expandIpCidrRange
{
"ipCidrRange": " IP_RANGE "
}
```
...
- ` REGION `: the name of the Google Cloud Dedicated region that contains the
subnet to modify.
...
```
POST https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks/ NETWORK /switchToCustomMode
```
...
```
PATCH https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networksa/ NETWORK 
{
"enableUlaInternalIpv6": true,
"internalIpv6Range": " ULA_IPV6_RANGE ",
}
...
```
PATCH https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks/ NETWORK 
{
"routingConfig": {
...
```
DELETE https://compute.apis-berlin-build0.goog/compute/v1/projects/ PROJECT_ID /global/networks/ NETWORK 
```
...
contact [Cloud Customer Care](https://berlin.devsitetest.how/support).
