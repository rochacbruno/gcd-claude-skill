...
](/compute/docs/images/os-details)
...
Bring up your Docker containers on Google Cloud Dedicated quickly, efficiently, and securely.
...
](/compute/docs/machine-resource#recommendations_for_machine_types)
...
VMs on Google Cloud Dedicated hardened by a set of security controls that help defend against rootkits and bootkits.