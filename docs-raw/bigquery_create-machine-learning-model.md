...
ml . [ create_model ](https://berlin.devsitetest.how/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html) ( 
...
ml . evaluate ( 
[ evaluate ](https://berlin.devsitetest.how/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html)odel_id , # For example: "bqml_tutorial.sample_model", 
input_ = eval_data , 
) 
# precision recall accuracy f1_score log_loss roc_auc 
...
predictions = ml . [ predict ](https://berlin.devsitetest.how/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html) ( 
your_model_id , # For example: "bqml_tutorial.sample_model", 
input_ = features , 
) 
