...
`service-org- ORGANIZATION_NUMBER @gcp-sa-biglakeidentityfed.eu0-system.iam.gserviceaccount.com`
...
`p- PROJECT_NUMBER - IDENTIFIER @gcp-sa-ftp.eu0-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-session.eu0-system.iam.gserviceaccount.com`
