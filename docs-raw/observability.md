...
Integrated monitoring, logging, and trace managed services for applications and systems running on Google Cloud Dedicated in Germany and beyond.
...
Store, search, analyze, monitor, and alert on log data and events from Google Cloud Dedicated in Germany and AWS.
...
Analyze, monitor, and display the performance data collected from your applications and the Google Cloud Dedicated in Germany services that you use.
...
](/compute/docs/instances/observe-monitor-vms)
...
](/sdk/gcloud/reference/monitoring)
