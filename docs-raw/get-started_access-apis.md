...
- [ Google Cloud Dedicated APIs: Access services programmatically ](#apis)
...
Google Cloud Dedicated APIs help you programmatically access Google Cloud Dedicated
...
your Google Cloud Dedicated resources.
...
For detailed instructions to complete setup steps, see [Google Cloud Dedicated in Germany Setup guided flow](/docs/enterprise/cloud-setup).

## Google Cloud Dedicated APIs: Access services programmatically

Google Cloud Dedicated APIs are programmatic interfaces to Google Cloud Dedicated
...
Google Cloud Dedicated resources. To retrieve the required data, you use the
Cloud Logging API.

You can access Google Cloud Dedicated APIs using REST calls or client libraries. We
...
tools or Google Cloud Dedicated console.
...
Cloud Client Libraries help you access Google Cloud Dedicated APIs from a supported
...
[Understand authentication in Google Cloud Dedicated in Germany](/docs/get-started/authentication)

- 

[Google Cloud Dedicated samples](/docs/samples)