...
Source: https://berlin.devsitetest.how/monitoring/docs/release-notes
...
](https://berlin.devsitetest.how/monitoring/quotas)
...
[feed URL](https://berlin.devsitetest.how/feeds/stackdriver-release-notes.xml) directly.
...
Ops Agent version 2.48.0 introduces support for Compute Engine VMs that are running Deep Learning VM Images based on Debian 11 (Bullseye). For more information, see [Operating systems](https://berlin.devsitetest.how/stackdriver/docs/solutions/agents/ops-agent#supported_operating_systems).
...
In the Monitoring API, you can now configure documentation links for your notifications. For more information, see [Links](https://berlin.devsitetest.how/monitoring/alerts/doc-variables#add-links).
...
[Show events on a dashboard](https://berlin.devsitetest.how/monitoring/dashboards/show-events).
...
- [Python example](https://berlin.devsitetest.how/stackdriver/docs/instrumentation/setup/python)

- [Node.js example](https://berlin.devsitetest.how/stackdriver/docs/instrumentation/setup/nodejs)

For general instrumentation information and recommendations, and for links to other samples, see:

- [Instrumentation and observability overview](https://berlin.devsitetest.how/stackdriver/docs/instrumentation/overview)

- [Choose an instrumentation approach](https://berlin.devsitetest.how/stackdriver/docs/instrumentation/choose-approach)