...
Source: https://documentation.s3ns.fr/iam/docs/manage-access-other-resources
...
- [ Grant or revoke multiple IAM roles using Cloud de Confiance console ](#multiple-roles-console)
...
Cloud de Confiance console, the Google Cloud CLI, and the REST API. You can also manage
access using the Cloud de Confiance client libraries.
...
almost all Cloud de Confiance resources.

## View current access

The following section shows you how to use the Cloud de Confiance console, the
gcloud CLI, and the REST API to view who has access to a
resource. You can also view access by using the Cloud de Confiance client
...
In the Cloud de Confiance console, go to the page that lists the resource that
...
In the Cloud de Confiance console, go to the page listing the resource that you
...
## Grant or revoke multiple IAM roles using Cloud de Confiance console
...
Cloud de Confiance client libraries.
