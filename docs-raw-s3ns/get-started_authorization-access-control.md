...
Source: https://documentation.s3ns.fr/docs/get-started/authorization-access-control
...
your Cloud de Confiance by S3NS environment.

Access is controlled with IAM permissions, which are required to
work with any resource in a Cloud de Confiance environment. When you're given
the permissions to work with a resource, you are *authorized* to access that
resource. Without the proper authorization, you can't access Cloud de Confiance
resources.
...
permissions, you can use that role to access Cloud de Confiance resources.

Generally, the workflow to perform an action on any resource in your
Cloud de Confiance environment looks like this:
...
from the permission error message in the Cloud de Confiance console.
...
access Cloud de Confiance resources. Users are represented by authenticated
...
Cloud de Confiance environment with IAM. But
...
Cloud de Confiance, there are other Cloud de Confiance services that can affect
...
control for projects and resources in Cloud de Confiance.
