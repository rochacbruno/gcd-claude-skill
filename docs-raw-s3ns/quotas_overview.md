...
- [ Quotas and the Cloud de Confiance hierarchy ](#gcp-hierarchy)
...
Cloud de Confiance by S3NS has three types of quotas:

- 

**Allocation quotas**: Allocation quotas restrict how much of a resource
Cloud de Confiance allocates to you. For example, Compute Engine applies an
allocation quota to the number of VMs allocated for a Cloud de Confiance
project.
...
## Quotas and the Cloud de Confiance hierarchy

Most quotas apply to one of the following levels of the Cloud de Confiance
...
within a Cloud de Confiance project. Using the resource in one project
...
within a Cloud de Confiance folder. Child folders and projects contribute to
...
resource usage within a Cloud de Confiance organization. Child folders and
...
Cloud de Confiance projects you can create is limited by a quota applied at the
level of the user or service account.

To identify the Cloud de Confiance hierarchy level of the quotas for your
...
Cloud de Confiance region. Resource use in any zone in the region
...
Cloud de Confiance zone. Resource usage in one zone doesn't affect available
...
[Cloud de Confiance](https://https://support.s3ns.fr)
support.
...
- Learn about [Cloud Quotas differences in Cloud de Confiance versus Google Cloud](/docs/quotas/tpc-differences)
