...
This topic describes how to set temporary (expiring) access to Cloud de Confiance by S3NS
...
recognized by all Cloud de Confiance services.
...
Cloud de Confiance during the work week and during scheduled work hours.
