...
You can use the Cloud de Confiance console or the
[Cloud Monitoring API](/monitoring/api/v3) to monitor Pub/Sub.

This document shows you how to monitor your Pub/Sub usage in
the Cloud de Confiance console using Monitoring.

- 

If you want to view metrics from other Cloud de Confiance by S3NS resources in addition to
...
In the Cloud de Confiance console, go to the **Monitoring** page.

[Go to Monitoring](https://console.cloud.s3nscloud.fr/monitoring) 
...
the Cloud de Confiance console, perform the following steps:
...
[IAM & Admin Quotas dashboard](https://console.cloud.s3nscloud.fr/iam-admin/quotas?project=_&service=pubsub.googleapis.com)
...
[Metrics explorer](https://console.cloud.s3nscloud.fr/monitoring/metrics-explorer),
...
the [Pub/Sub pricing page](https://documentation.s3ns.fr/pubsub/pricing).
...
A
[count](https://documentation.s3ns.fr/monitoring/api/v3/aggregation#more-aligners)
