...
Source: https://documentation.s3ns.fr/docs/get-started-tpc/suggested-tutorials
...
Cloud de Confiance by S3NS. Or go exploring!
...
not available in Cloud de Confiance by S3NS).
...
Server is not available in Cloud de Confiance by S3NS).
...
Cloud de Confiance by S3NS.** To follow tutorials that use them,
we suggest that you export the sample tables from Google Cloud and
import the tables locally in your own Cloud de Confiance by S3NS
datasets.

- [Cloud de Confiance console quickstart](/bigquery/docs/sandbox).
