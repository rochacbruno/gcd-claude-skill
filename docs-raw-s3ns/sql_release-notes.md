...
](https://documentation.s3ns.fr/sql/docs/resources)
...
You can see the latest product updates for all of Cloud de Confiance by S3NS on the
[
Cloud de Confiance](/release-notes) page, browse and filter all release notes in the
[Cloud de Confiance console](https://console.cloud.s3nscloud.fr/release-notes),
or programmatically access release notes in
[BigQuery](https://console.cloud.s3nscloud.fr/bigquery?p=bigquery-public-data&d=google_cloud_release_notes&t=release_notes&page=table).
...
[feed URL](https://documentation.s3ns.fr/feeds/cloud-sql-release-notes.xml) directly.
...
replica](https://documentation.s3ns.fr/sql/docs/mysql/configure-cmek#reencrypt).
...
For more information, see [Re-encrypt an existing CMEK-enabled instance or
replica](https://documentation.s3ns.fr/sql/docs/postgres/configure-cmek#reencrypt).
...
[About Private Service Connect](https://documentation.s3ns.fr/sql/docs/mysql/about-private-service-connect#psc-outbound).
...
For more information about Private Service Connect outbound connectivity see
[About Private Service Connect](https://documentation.s3ns.fr/sql/docs/postgres/about-private-service-connect#psc-outbound).
...
option](https://documentation.s3ns.fr/sql/docs/postgres/backup-recovery/backup-options).
...
is now generally available ([GA](https://documentation.s3ns.fr/products/#product-launch-stages)).
...
MySQL 8.0.44 is now the [default minor version](https://documentation.s3ns.fr/sql/docs/mysql/db-versions#database-version-support) for Cloud SQL for MySQL 8.0.

For more information about minor version support in Cloud SQL for MySQL, see
[MySQL 8.0](https://documentation.s3ns.fr/sql/docs/mysql/db-versions#mysql-8.0).
...
To upgrade your existing instance to the new minor version, see
[Upgrade the database minor version](https://documentation.s3ns.fr/sql/docs/mysql/upgrade-minor-db-version#manual-upgrade).
...
You can now execute SQL statements using the [Cloud SQL Data API](https://documentation.s3ns.fr/sql/docs/mysql/executesql-instance) for
...
You can now execute SQL statements using the [Cloud SQL Data API](https://documentation.s3ns.fr/sql/docs/postgres/executesql-instance) for
administrative queries.
...
[`[MYSQL_$VERSION].R20251004.01_07`](https://documentation.s3ns.fr/sql/docs/mysql/maintenance-changelog/)
or later installed on your MySQL instance.

For more information, see [Search approximate nearest neighbors (ANN)](https://documentation.s3ns.fr/sql/docs/mysql/search-filter-vector-embeddings#ann).
...
As of January 13, 2025, the legacy configuration for high availability (HA) is deprecated for all Cloud SQL for MySQL instances. You can no longer create instances with the legacy HA configuration, and you can no longer enable the legacy HA configuration on existing instances. In addition, after January 13, 2025, legacy HA instances are no longer covered by the [Cloud SQL SLA](https://documentation.s3ns.fr/sql/sla).
...
For more information, see [Use query insights to improve query performance](/sql/docs/mysql/using-query-insights#query-insights-for-enterprise-plus). Query insights for Cloud SQL Cloud SQL Enterprise Plus edition is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
For more information, see [Use query insights to improve query performance](/sql/docs/postgres/using-query-insights#query-insights-for-enterprise-plus). Query insights for Cloud SQL Cloud SQL Enterprise Plus edition is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
The System insights dashboard displays the metrics for the resources that your instance is using and can help you analyze the performance of your instance. For more information, see [Use system insights to improve system performance](/sql/docs/sqlserver/use-system-insights). System insights is [generally available](https://documentation.s3ns.fr/products#product-launch-stages) (GA).
...
You can now create instances with both private services access and Private Service Connect enabled for them. You can also enable Private Service Connect for existing private services access instances. This feature is available in [Preview](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Configure both private services access and Private Service Connect](/sql/docs/postgres/configure-private-services-access-and-private-service-connect).
...
You can now create instances with both private services access and Private Service Connect enabled for them. You can also enable Private Service Connect for existing private services access instances. This feature is available in [Preview](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Configure both private services access and Private Service Connect](/sql/docs/sqlserver/configure-private-services-access-and-private-service-connect).
...
You can now set up AlloyDB clusters using a copy of your Cloud SQL for PostgreSQL backup. This feature is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Migrate from Cloud SQL for PostgreSQL to AlloyDB](/sql/docs/postgres/backup-recovery/migrate-cloud-sql-to-alloydb).
...
For [Cloud SQL Enterprise Plus edition](/sql/docs/mysql/editions-intro) instances, advanced disaster recovery (DR) is now [generally available (GA)](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Advanced disaster recovery (DR)](/sql/docs/mysql/intro-to-cloud-sql-disaster-recovery#advanced-dr) and [Use advanced disaster recovery (DR)](/sql/docs/mysql/use-advanced-disaster-recovery).
...
The write endpoint feature is now available in [Preview](https://documentation.s3ns.fr/products#product-launch-stages). This endpoint is a global domain name service (DNS) name. This name resolves to the IP address of the current primary Cloud SQL instance that's enabled with private services access.
...
For more information, see [Advanced disaster recovery (DR)](/sql/docs/postgres/intro-to-cloud-sql-disaster-recovery#advanced-dr) and [Use advanced disaster recovery (DR)](/sql/docs/postgres/use-advanced-disaster-recovery). This feature is [generally available](https://documentation.s3ns.fr/products#product-launch-stages) (GA).
...
The `pgvector` extension is now upgraded from version 0.7.4 to version 0.8.0. Use this extension to store and search for vector embeddings in PostgreSQL databases. For more information, see [Configure PostgreSQL extensions](https://documentation.s3ns.fr/sql/docs/postgres/extensions). 
...
PostgreSQL version 17 is now [generally available](https://documentation.s3ns.fr/products#product-launch-stages).
...
You can [export the transaction logs](/sql/docs/sqlserver/import-export/import-export-bak) for point-in-time recovery (PITR) that Cloud SQL stores in Cloud Storage. This feature is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
For more information about each option, see [Certificate authority (CA) hierarchies](/sql/docs/mysql/authorize-ssl#certificate_authority_ca_hierarchies). This feature is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
For more information about each option, see [Certificate authority (CA) hierarchies](/sql/docs/postgres/authorize-ssl#certificate_authority_ca_hierarchies). This feature is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
For more information about each option, see [Certificate authority (CA) hierarchies](/sql/docs/sqlserver/authorize-ssl#certificate_authority_ca_hierarchies). This feature is in [Preview](https://documentation.s3ns.fr/products#product-launch-stages).
...
Cloud SQL is discontinuing support for [legacy high availability (HA)](https://documentation.s3ns.fr/sql/docs/mysql/configure-legacy-ha) instance configuration on January 6, 2025. After this date, you can't create Cloud SQL for MySQL instances with the legacy configuration for high availability. You also can't enable the legacy configuration for high availability on existing instances. Until January 6, 2025, legacy HA instances are still covered by the [Cloud SQL SLA](https://documentation.s3ns.fr/sql/sla). We recommend that you [upgrade your existing legacy HA instances](/sql/docs/mysql/configure-legacy-ha#update-from-legacy) to regional persistent disk HA instances as soon as possible and create new HA instances using regional persistent disk instead.
...
Extended support pricing is now available for Cloud SQL for MySQL. To view pricing details, see [Cloud SQL pricing](https://documentation.s3ns.fr/sql/pricing#extended-support-pricing).
...
Extended support pricing is now available for Cloud SQL for PostgreSQL. To view pricing details, see [Cloud SQL pricing](https://documentation.s3ns.fr/sql/pricing#extended-support-pricing).
...
Migrating your external MySQL 5.7 and 8.0 databases into Cloud SQL for MySQL by using Percona XtraBackup physical files is now [generally available](https://documentation.s3ns.fr/products#product-launch-stages) (GA).
...
Cloud SQL Studio is now [generally available](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Manage your data using Cloud SQL Studio](/sql/docs/mysql/manage-data-using-studio).
...
Cloud SQL Studio is now [generally available](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Manage your data using Cloud SQL Studio](/sql/docs/postgres/manage-data-using-studio).
...
Cloud SQL Studio is now [generally available](https://documentation.s3ns.fr/products#product-launch-stages). For more information, see [Manage your data using Cloud SQL Studio](/sql/docs/sqlserver/manage-data-using-studio).
