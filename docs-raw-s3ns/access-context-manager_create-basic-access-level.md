...
Source: https://documentation.s3ns.fr/access-context-manager/docs/create-basic-access-level
...
custom access levels and use **Advanced Mode** in the Cloud de Confiance console, see
...
Open the **Access Context Manager** page in the Cloud de Confiance console.

[Open the Access Context Manager page](https://console.cloud.s3nscloud.fr/security/access-level)
...
is displayed in the Cloud de Confiance console.
...
requires an identity to interact with other Cloud de Confiance by S3NS services.
...
The Cloud de Confiance console does not currently support adding principals to
...
(`service@project.s3ns.iam.gserviceaccount.com`).


```
- members : 
- user:sysadmin@example.com 
- serviceAccount:service@project. s3ns.iam.gserviceaccount.com
```
