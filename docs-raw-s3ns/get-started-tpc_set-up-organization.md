...
When you first onboard to Cloud de Confiance, you
...
other resources. Cloud de Confiance provides
...
Cloud de Confiance features in a new
...
organization using the Google Cloud CLI or the Cloud de Confiance console, or
...
organization in Cloud de Confiance. If you
...
Cloud de Confiance console, following the instructions in the relevant documentation.

Configuration from the Cloud de Confiance console is not available in
Cloud de Confiance.
