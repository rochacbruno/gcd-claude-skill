...
Source: https://documentation.s3ns.fr/service-usage/docs/reference/rest
...
](https://documentation.s3ns.fr/service-usage/docs/apis)
...
Enables services that service consumers want to use on Cloud de Confiance Platform, lists the available or enabled services, or disables services that service consumers no longer use.
...
- [https://serviceusage.s3nsapis.fr/$discovery/rest?version=v2beta](https://serviceusage.s3nsapis.fr/$discovery/rest?version=v2beta)

- [https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1](https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1)

- [https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1beta1](https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1beta1)
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.GetConsumerQuotaMetric` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.ImportAdminOverrides` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.ImportConsumerOverrides` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.ListConsumerQuotaMetrics` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.GetConsumerQuotaLimit` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.CreateAdminOverride` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.DeleteAdminOverride` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.ListAdminOverrides` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.UpdateAdminOverride` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.CreateConsumerOverride` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.DeleteConsumerOverride` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.ListConsumerOverrides` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.api.serviceusage.v1beta1.ServiceUsage.UpdateConsumerOverride` is not available in Cloud de Confiance by S3NS. | 
|
