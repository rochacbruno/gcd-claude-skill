...
You can import the state for any Cloud de Confiance by S3NS resource.
...
- In bulk by using a Cloud de Confiance feature that lets you [import
...
The ID is an identifier that identifies a resource in Cloud de Confiance by S3NS
...
Bulk export lets you export Cloud de Confiance resources
