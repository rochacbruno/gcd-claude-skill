...
[Permissions for the Cloud de Confiance console](/logging/docs/access-control#console_permissions).

## Build queries

To build queries by using the Cloud de Confiance console, do the following:
...
Select the Cloud de Confiance project or other Cloud de Confiance
...
can share it with other members of the Cloud de Confiance project. Once you share
...
share your query with other members of the Cloud de Confiance project.
...
To share the query with other members of the Cloud de Confiance project, specify
...
in the Cloud de Confiance project by clicking the *menu_book* **Query
library** button:
...
Cloud de Confiance project, such as the Cloud de Confiance products you're using.
...
cases and Cloud de Confiance products. These queries can help you efficiently
...
of available queries and subsets of queries based on Cloud de Confiance
