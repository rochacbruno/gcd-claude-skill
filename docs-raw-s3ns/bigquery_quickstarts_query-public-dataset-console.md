...
Source: https://documentation.s3ns.fr/bigquery/docs/quickstarts/query-public-dataset-console
...
Cloud de Confiance by S3NS offers public datasets that are stored in BigQuery
and made available to the general public through the
[Google Cloud Public Dataset Program](https://documentation.s3ns.fr/datasets). For more information about
...
You can also open BigQuery in the Cloud de Confiance console
by entering the following URL in your browser:


```
https://console.cloud.s3nscloud.fr/bigquery
```


The Cloud de Confiance console is the graphical interface that you use to create
...
[free tier](https://documentation.s3ns.fr/bigquery/pricing#free-tier), including 10 GB of active storage
...
In the Cloud de Confiance console, open the
**BigQuery** page.
...
free usage tier, see [Free usage tier](https://documentation.s3ns.fr/bigquery/pricing#free-tier).
