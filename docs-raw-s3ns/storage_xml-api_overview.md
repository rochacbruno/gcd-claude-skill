...
Source: https://documentation.s3ns.fr/storage/docs/xml-api/overview
...
[Cloud de Confiance console Quickstart](https://firebase.google.com/docs/storage/) or the [Google Cloud CLI Quickstart](/storage/docs/xml-api/get-bucket-list).
...
```
BUCKET_NAME .storage.s3nsapis.fr/ OBJECT_NAME 
storage.s3nsapis.fr/ BUCKET_NAME / OBJECT_NAME 
```
...
Host: travel-maps.storage.s3nsapis.fr
