...
Source: https://documentation.s3ns.fr/compute/docs/release-notes
...
](https://documentation.s3ns.fr/compute/docs/resources)
...
[feed URL](https://documentation.s3ns.fr/feeds/compute-release-notes.xml) directly.
...
computing (HPC) workloads on Cloud de Confiance by S3NS.
...
use the Cloud de Confiance console, Google Cloud CLI, API, and Terraform to view and manage
