...
Source: https://documentation.s3ns.fr/resource-manager/docs/creating-managing-folders
...
This page describes how to create Cloud de Confiance by S3NS folders to group and organize projects
...
each with its own set of Cloud de Confiance resources. Folders allow
...
- In the Cloud de Confiance console, open the **Manage resources** page.
...
page](https://console.cloud.s3nscloud.fr/cloud-resource-manager)
...
You can retrieve the ID of a folder using the Cloud de Confiance console or
Google Cloud CLI.
...
propagate through our global systems and become visible in the Cloud de Confiance console.
...
[
Open the Manage Resources page](https://console.cloud.s3nscloud.fr/cloud-resource-manager)
...
by Cloud de Confiance by S3NS because they require global propagation. To avoid blocking your
