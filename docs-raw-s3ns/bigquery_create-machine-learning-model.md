...
To learn how to create models by using the Cloud de Confiance console user interface, see
...
This tutorial uses billable components of Cloud de Confiance by S3NS,
...
[BigQuery pricing](https://documentation.s3ns.fr/bigquery/pricing) page.

For more information on BigQuery ML costs, see
[BigQuery ML pricing](https://documentation.s3ns.fr/bigquery/pricing#bigquery-ml-pricing).
...
[Go to IAM](https://console.cloud.s3nscloud.fr/projectselector/iam-admin/iam?supportedpurview=project)
...
[Enable the API](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=bigquery)
...
bqclient = google . cloud . [ bigquery ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest) . [ Client ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html) () 
bqclient . [ create_dataset ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html#google_cloud_bigquery_client_Client_create_dataset) ( "bqml_tutorial" , exists_ok = True ) 
```
...
ml . [ create_model ](https://documentation.s3ns.fr/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html) ( 
...
Use the Cloud de Confiance console to see how the model's loss changes over the
...
Evaluate the performance of the model by using the
[`ML.EVALUATE` function](/bigquery/docs/reference/standard-sql/bigqueryml-syntax-evaluate)
or the
[`bigframes.bigquery.ml.evaluate` BigQuery DataFrames function](https://dataframes.bigquery.dev/reference/api/bigframes.bigquery.ml.evaluate.html#bigframes.bigquery.ml.evaluate).
The `ML.EVALUATE` and `bigframes.bigquery.ml.evaluate` functions evaluate the predicted values
generated by the model against the actual data. To calculate logistic regression specific
metrics, you can use the
[`ML.ROC_CURVE` function](/bigquery/docs/reference/standard-sql/bigqueryml-syntax-roc).
...
ml . evaluate ( 
[ evaluate ](https://documentation.s3ns.fr/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html)odel_id , # For example: "bqml_tutorial.sample_model", 
input_ = eval_data , 
) 
# precision recall accuracy f1_score log_loss roc_auc 
...
predictions = ml . [ predict ](https://documentation.s3ns.fr/python/docs/reference/bigframes/latest/bigframes.bigquery.ml.html) ( 
your_model_id , # For example: "bqml_tutorial.sample_model", 
input_ = features , 
) 
...
To avoid incurring charges to your Cloud de Confiance account for
...
- To learn more about the Cloud de Confiance console, see
[Using the Cloud de Confiance console](/bigquery/bigquery-web-ui).