...
Source: https://documentation.s3ns.fr/dns/docs/records
...
[Go to Cloud DNS zones](https://console.cloud.s3nscloud.fr/net-services/dns/) 
...
In the Cloud de Confiance console, go to the **Cloud DNS zones**
page.
