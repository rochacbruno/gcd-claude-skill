...
Source: https://documentation.s3ns.fr/docs/quotas/implement-common-use-cases
...
in your Cloud de Confiance by S3NS projects, folders, or organization.
...
contact, in case Cloud de Confiance by S3NS needs more information before additional quota
can be granted.
...
While Cloud de Confiance by S3NS evaluates the requested quota value, the reconciling status
of your quota is set to `true`.

Sometimes Cloud de Confiance by S3NS approves part of your increase request instead of
...
When Cloud de Confiance by S3NS denies or partially approves a customer request, the
...
be visible in the Cloud de Confiance console. You may need to use the
...
This value only appears in the Cloud de Confiance console for GPU families that you have
...
- ` EMAIL `: An email address that can be used as a
contact, in case Cloud de Confiance by S3NS needs more information before additional
