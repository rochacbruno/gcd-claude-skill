...
To create a topic you can use the Cloud de Confiance console, the Google Cloud CLI,
...
features of Cloud de Confiance. To create an import topic for
...
In the Cloud de Confiance console, go to the Pub/Sub **Create topic**
page.

[Go to Create topic](https://console.cloud.s3nscloud.fr/cloudpubsub/topic/create)
...
using [ Grpc.Core ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.html) ; 
using System ; 
...
var topicName = [ TopicName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html) . [ FromProjectTopic ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html#Google_Cloud_PubSub_V1_TopicName_FromProjectTopic_System_String_System_String_) ( projectId , topicId ); 
[ Topic ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.Topic.html) topic = null ; 

try 
{ 
topic = publisher . [ CreateTopic ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_CreateTopic_Google_Cloud_PubSub_V1_Topic_Google_Api_Gax_Grpc_CallSettings_) ( topicName ); 
Console . WriteLine ( $"Topic {topic.[Name](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.Topic.html#Google_Cloud_PubSub_V1_Topic_Name)} created." ); 
} 
catch ( [ RpcException ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.RpcException.html) e ) when ( e . [ Status ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.Status.html) . [ StatusCode ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.StatusCode.html) == [ StatusCode ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.StatusCode.html) . [ AlreadyExists ](https://documentation.s3ns.fr/dotnet/docs/reference/Grpc.Core/latest/Grpc.Core.StatusCode.html#Grpc_Core_StatusCode_AlreadyExists) ) 
{ 
...
import com.google.pubsub.v1.[Topic](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Topic.html) ; 
...
[ Topic ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Topic.html) topic = topicAdminClient . createTopic ( topicName ); 
System . out . println ( "Created topic: " + topic . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Topic.html#com_google_pubsub_v1_Topic_getName__) ()); 
} 
} 
} 
```
