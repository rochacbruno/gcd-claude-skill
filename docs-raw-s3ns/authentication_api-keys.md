...
The [**Credentials** page](https://console.cloud.s3nscloud.fr/apis/credentials) in the
Cloud de Confiance console ensures that the correct type of API key is created for a
selected API.
...
[express mode](https://documentation.s3ns.fr/resources/cloud-express-faqs).
...
ID 
The API key ID is used by Cloud de Confiance administrative tools to uniquely
identify the key. The key ID can't be used to access APIs. The key ID can be
found in the URL of the key's edit page in the Cloud de Confiance console. You can also
...
When you use the Cloud de Confiance console to access Cloud de Confiance by S3NS services and
...
- [Service Account API Key Binding Admin ](/iam/docs/roles-permissions/iam#iam.serviceAccountApiKeyBindingAdmin) (`roles/iam.serviceAccountApiKeyBindingAdmin`)
...
[Go to Organization policies](https://console.cloud.s3nscloud.fr/iam-admin/orgpolicies/list)
...
[Go to Credentials](https://console.cloud.s3nscloud.fr/apis/credentials)
...
[API dashboard](https://console.cloud.s3nscloud.fr/apis/dashboard). Service names are strings
...
```
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[ApiTarget](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiTarget.html) ; 
import com.google.api.apikeys.v2.[CreateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.CreateKeyRequest.html) ; 
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[LocationName](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LocationName.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
...
try ( [ ApiKeysClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) apiKeysClient = [ ApiKeysClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) . create ()) { 

[ Key ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) key = [ Key ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) . newBuilder () 
. [ setDisplayName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.Builder.html#com_google_api_apikeys_v2_Key_Builder_setDisplayName_java_lang_String_) ( "My first API key" ) 
// Set the API key restriction. 
// You can also set browser/ server/ android/ ios based restrictions. 
// For more information on API key restriction, see: 
// https://cloud.google.com/docs/authentication/api-keys#api_key_restrictions 
. [ setRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.Builder.html#com_google_api_apikeys_v2_Key_Builder_setRestrictions_com_google_api_apikeys_v2_Restrictions_) ( [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
...
. [ addApiTargets ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_addApiTargets_com_google_api_apikeys_v2_ApiTarget_) ( [ ApiTarget ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiTarget.html) . newBuilder () 
. [ setService ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiTarget.Builder.html#com_google_api_apikeys_v2_ApiTarget_Builder_setService_java_lang_String_) ( "translate.googleapis.com" ) 
. [ addMethods ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiTarget.Builder.html#com_google_api_apikeys_v2_ApiTarget_Builder_addMethods_java_lang_String_) ( "translate.googleapis.com.TranslateText" ) 
. build ()) 
. build ()) 
. build (); 

// Initialize request and set arguments. 
[ CreateKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.CreateKeyRequest.html) createKeyRequest = [ CreateKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.CreateKeyRequest.html) . newBuilder () 
// API keys can only be global. 
. setParent ( [ LocationName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LocationName.html) . of ( projectId , "global" ). toString ()) 
. setKey ( key ) 
. build (); 
...
System . out . printf ( "Successfully created an API key: %s" , result . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html#com_google_api_apikeys_v2_Key_getName__) ()); 
} 
} 
} 
```
...
```
from google.cloud import [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest)
from google.cloud.api_keys_v2 import [ Key ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.Key.html)
...
client = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ ApiKeysClient ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.services.api_keys.ApiKeysClient.html) () 

key = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ Key ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.Key.html) () 
key . display_name = f "My first API key - { suffix } " 

# Initialize request and set arguments. 
request = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ CreateKeyRequest ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.CreateKeyRequest.html) () 
request . parent = f "projects/ { project_id } /locations/global" 
request . key = key 

# Make the request and wait for the operation to complete. 
response = client . [ create_key ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.services.api_keys.ApiKeysClient.html#google_cloud_api_keys_v2_services_api_keys_ApiKeysClient_create_key) ( request = request ) . result () 
...
` PROJECT_ID `: Your Cloud de Confiance by S3NS project ID or name.
...
**[API restrictions](#adding-api-restrictions)**: Limit an API key to only be
used with a specific set of APIs. API keys without API restrictions can be
used with all APIs that accept keys generated by Cloud de Confiance by S3NS. API
restrictions can be mandatory, depending on how you create an API key:

- 

In the Cloud de Confiance console and the gcloud CLI, you must add
at least one API restriction to create an API key.

- 

When you create API keys using the REST API, the keys are unrestricted
unless you specify a restriction. To do so, add the
...
You can find the service name by searching for the API on the
[API dashboard](https://console.cloud.s3nscloud.fr/apis/dashboard). Service
...
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
import com.google.api.apikeys.v2.[UpdateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) ; 
...
// Restrict the API key usage by specifying the target service and methods. 
// The API key can only be used to authenticate the specified methods in the service. 
[ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) restrictions = [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
. [ addApiTargets ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_addApiTargets_com_google_api_apikeys_v2_ApiTarget_) ( [ ApiTarget ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiTarget.html) . newBuilder () 
...
. [ setRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.Builder.html#com_google_api_apikeys_v2_Key_Builder_setRestrictions_com_google_api_apikeys_v2_Restrictions_) ( restrictions ) 
. build (); 

// Initialize request and set arguments. 
[ UpdateKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) updateKeyRequest = [ UpdateKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) . newBuilder () 
. setKey ( key ) 
. [ setUpdateMask ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.Builder.html#com_google_api_apikeys_v2_UpdateKeyRequest_Builder_setUpdateMask_com_google_protobuf_FieldMask_) ( [ FieldMask ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) . newBuilder (). [ addPaths ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.Builder.html#com_google_protobuf_FieldMask_Builder_addPaths_java_lang_String_) ( "restrictions" ). build ()) 
. build (); 

// Make the request and wait for the operation to complete. 
[ Key ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) result = apiKeysClient . [ updateKeyAsync ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html#com_google_api_apikeys_v2_ApiKeysClient_updateKeyAsync_com_google_api_apikeys_v2_Key_com_google_protobuf_FieldMask_) ( updateKeyRequest ). get ( 3 , TimeUnit . MINUTES ); 

// For authenticating with the API key, use the value in "result.getKeyString()". 
System . out . printf ( "Successfully updated the API key: %s" , result . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html#com_google_api_apikeys_v2_Key_getName__) ()); 
} 
} 
} 
```
...
# Restrict the API key usage by specifying the target service and methods. 
# The API key can only be used to authenticate the specified methods in the service. 
api_target = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ ApiTarget ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.ApiTarget.html) () 
...
# For more information on API key restriction, see: 
# https://cloud.google.com/docs/authentication/api-keys 
restrictions = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ Restrictions ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.Restrictions.html) () 
...
# Initialize request and set arguments. 
request = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ UpdateKeyRequest ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.UpdateKeyRequest.html) () 
request . key = key 
request . update_mask = "restrictions" 

# Make the request and wait for the operation to complete. 
response = client . [ update_key ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.services.api_keys.ApiKeysClient.html#google_cloud_api_keys_v2_services_api_keys_ApiKeysClient_update_key) ( request = request ) . result () 
...
Replace ` PROJECT_ID ` with your Cloud de Confiance by S3NS project
ID or name.
...
` PROJECT_ID `: Your Cloud de Confiance by S3NS project ID or
name.
...
```
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[BrowserKeyRestrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.BrowserKeyRestrictions.html) ; 
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
import com.google.api.apikeys.v2.[UpdateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) ; 
import com.google.protobuf.[FieldMask](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) ; 
...
[ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) restrictions = [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
. [ setBrowserKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_setBrowserKeyRestrictions_com_google_api_apikeys_v2_BrowserKeyRestrictions_) ( [ BrowserKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.BrowserKeyRestrictions.html) . newBuilder () 
. [ addAllowedReferrers ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.BrowserKeyRestrictions.Builder.html#com_google_api_apikeys_v2_BrowserKeyRestrictions_Builder_addAllowedReferrers_java_lang_String_) ( "www.example.com/*" ) 
. build ()) 
. build (); 
...
browser_key_restrictions = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ BrowserKeyRestrictions ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.BrowserKeyRestrictions.html) () 
...
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
import com.google.api.apikeys.v2.[ServerKeyRestrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ServerKeyRestrictions.html) ; 
import com.google.api.apikeys.v2.[UpdateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) ; 
import com.google.protobuf.[FieldMask](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) ; 
import java.io.IOException ; 
...
[ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) restrictions = [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
. [ setServerKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_setServerKeyRestrictions_com_google_api_apikeys_v2_ServerKeyRestrictions_) ( [ ServerKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ServerKeyRestrictions.html) . newBuilder () 
. [ addAllAllowedIps ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ServerKeyRestrictions.Builder.html#com_google_api_apikeys_v2_ServerKeyRestrictions_Builder_addAllAllowedIps_java_lang_Iterable_java_lang_String__) ( Arrays . asList ( "198.51.100.0/24" , "2000:db8::/64" )) 
. build ()) 
. build (); 
...
# Restrict the API key usage by specifying the IP addresses. 
# You can specify the IP addresses in IPv4 or IPv6 or a subnet using CIDR notation. 
server_key_restrictions = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ ServerKeyRestrictions ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.ServerKeyRestrictions.html) () 
...
Replace ` PROJECT_ID ` with your Cloud de Confiance by S3NS project ID
or name.
...
```
import com.google.api.apikeys.v2.[AndroidApplication](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidApplication.html) ; 
import com.google.api.apikeys.v2.[AndroidKeyRestrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidKeyRestrictions.html) ; 
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
import com.google.api.apikeys.v2.[UpdateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) ; 
...
[ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) restrictions = [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
. [ setAndroidKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_setAndroidKeyRestrictions_com_google_api_apikeys_v2_AndroidKeyRestrictions_) ( [ AndroidKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidKeyRestrictions.html) . newBuilder () 
. [ addAllowedApplications ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidKeyRestrictions.Builder.html#com_google_api_apikeys_v2_AndroidKeyRestrictions_Builder_addAllowedApplications_com_google_api_apikeys_v2_AndroidApplication_) ( [ AndroidApplication ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidApplication.html) . newBuilder () 
// Specify the android application's package name and SHA1 fingerprint. 
. [ setPackageName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidApplication.Builder.html#com_google_api_apikeys_v2_AndroidApplication_Builder_setPackageName_java_lang_String_) ( "com.google.appname" ) 
. [ setSha1Fingerprint ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.AndroidApplication.Builder.html#com_google_api_apikeys_v2_AndroidApplication_Builder_setSha1Fingerprint_java_lang_String_) ( "0873D391E987982FBBD30873D391E987982FBBD3" ) 
. build ()) 
. build ()) 
. build (); 
...
# Specify the android application's package name and SHA1 fingerprint. 
allowed_application = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ AndroidApplication ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.AndroidApplication.html) () 
...
android_key_restriction = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ AndroidKeyRestrictions ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.AndroidKeyRestrictions.html) () 
...
```
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[IosKeyRestrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.IosKeyRestrictions.html) ; 
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[Restrictions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) ; 
import com.google.api.apikeys.v2.[UpdateKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UpdateKeyRequest.html) ; 
import com.google.protobuf.[FieldMask](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) ; 
...
[ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) restrictions = [ Restrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.html) . newBuilder () 
. [ setIosKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Restrictions.Builder.html#com_google_api_apikeys_v2_Restrictions_Builder_setIosKeyRestrictions_com_google_api_apikeys_v2_IosKeyRestrictions_) ( [ IosKeyRestrictions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.IosKeyRestrictions.html) . newBuilder () 
. [ addAllAllowedBundleIds ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.IosKeyRestrictions.Builder.html#com_google_api_apikeys_v2_IosKeyRestrictions_Builder_addAllAllowedBundleIds_java_lang_Iterable_java_lang_String__) ( Arrays . asList ( "com.google.gmail" , "com.google.drive" )) 
. build ()) 
. build (); 
...
ios_key_restrictions = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ IosKeyRestrictions ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.IosKeyRestrictions.html) () 
...
Go to the Cloud Asset Inventory library page in the Cloud de Confiance console and check
...
[Go to the Library** page](https://console.cloud.s3nscloud.fr/apis/library/cloudasset.googleapis.com)
...
You can determine which Cloud de Confiance project an API key is associated with
from its string.
...
```
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[LookupKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyRequest.html) ; 
import com.google.api.apikeys.v2.[LookupKeyResponse](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyResponse.html) ; 
import java.io.IOException ; 
...
[ LookupKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyRequest.html) lookupKeyRequest = [ LookupKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyRequest.html) . newBuilder () 
. setKeyString ( apiKeyString ) 
. build (); 

// Make the request and obtain the response. 
[ LookupKeyResponse ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyResponse.html) response = apiKeysClient . lookupKey ( lookupKeyRequest ); 

System . out . printf ( "Successfully retrieved the API key name: %s" , response . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.LookupKeyResponse.html#com_google_api_apikeys_v2_LookupKeyResponse_getName__) ()); 
} 
} 
} 
```
...
# Initialize the lookup request and set the API key string. 
lookup_key_request = [ api_keys_v2 ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest) . [ LookupKeyRequest ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.types.LookupKeyRequest.html) ( 
...
# Make the request and obtain the response. 
lookup_key_response = client . [ lookup_key ](https://documentation.s3ns.fr/python/docs/reference/apikeys/latest/google.cloud.api_keys_v2.services.api_keys.ApiKeysClient.html#google_cloud_api_keys_v2_services_api_keys_ApiKeysClient_lookup_key) ( lookup_key_request ) 
...
The copy operation is available only in the Cloud de Confiance console. To use other
...
The rotation operation is available only in the Cloud de Confiance console. To use other
methods, follow the steps to [create an API key](#create), and then
[apply the same API key restrictions](#adding-api-restrictions) to the newly
...
import com.google.api.apikeys.v2.[ApiKeysClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html) ; 
import com.google.api.apikeys.v2.[Key](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) ; 
import com.google.api.apikeys.v2.[UndeleteKeyRequest](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UndeleteKeyRequest.html) ; 
import java.io.IOException ; 
import java.util.concurrent.ExecutionException ; 
import java.util.concurrent.TimeUnit ; 
import java.util.concurrent.TimeoutException ; 
...
[ UndeleteKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UndeleteKeyRequest.html) undeleteKeyRequest = [ UndeleteKeyRequest ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.UndeleteKeyRequest.html) . newBuilder () 
. setName ( String . format ( "projects/%s/locations/global/keys/%s" , projectId , keyId )) 
. build (); 

// Make the request and wait for the operation to complete. 
[ Key ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html) undeletedKey = apiKeysClient . [ undeleteKeyAsync ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.ApiKeysClient.html#com_google_api_apikeys_v2_ApiKeysClient_undeleteKeyAsync_com_google_api_apikeys_v2_UndeleteKeyRequest_) ( undeleteKeyRequest ) 
. get ( 3 , TimeUnit . MINUTES ); 

System . out . printf ( "Successfully undeleted the API key: %s" , undeletedKey . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-apikeys/latest/com.google.api.apikeys.v2.Key.html#com_google_api_apikeys_v2_Key_getName__) ()); 
} 
} 
} 
```
