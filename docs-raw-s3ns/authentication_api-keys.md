...
- 
Restrict an API key to specific APIs by using the Cloud de Confiance console:
...
can be used with all APIs that accept keys generated by Cloud de Confiance by S3NS.
...
In the Cloud de Confiance console, you must add at least one API restriction to be
