# Export your Cloud de Confiance by S3NS resources to Terraform format

Source: https://documentation.s3ns.fr/docs/terraform/resource-management/export
...
You've deployed resources in Cloud de Confiance, and now need to manage your
...
the default Cloud de Confiance project where you want to generate Terraform code for the
deployed resources.
...
Config Connector lets you use Cloud de Confiance's Terraform bulk-export tool.
...
(`gcp-sa-cloudasset.s3ns-system.iam.gserviceaccount.com`) has the
...
- [Import your Cloud de Confiance by S3NS resources into Terraform
