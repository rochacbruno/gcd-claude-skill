...
Source: https://documentation.s3ns.fr/dns/docs/zones
...
- 
[
Enable the Cloud DNS API in the Cloud de Confiance console](https://console.cloud.s3nscloud.fr/start/api?id=dns&credential=client_key). You can
...
Cloud de Confiance console. You can also ask your user to provide the
...
If you want to run a `gcloud` command on Cloud de Confiance by S3NS resources
...
[Cloud de Confiance project](/resource-manager/docs/creating-managing-projects).
...
You can create a Service Directory zone that allows your Cloud de Confiance-based
...
[Go to Cloud DNS zones](https://console.cloud.s3nscloud.fr/networking/dns/zones/)
