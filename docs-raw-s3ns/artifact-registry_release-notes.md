...
Source: https://documentation.s3ns.fr/artifact-registry/docs/release-notes
...
](https://documentation.s3ns.fr/artifact-registry/docs/resources)
...
[feed URL](https://documentation.s3ns.fr/feeds/artifactregistry-release-notes.xml) directly.
...
Artifact Registry is available in the `europe-north2` region (Stockholm). For more information, see [Global locations](https://documentation.s3ns.fr/about/locations).
...
Artifact Registry support for [OCI specifications v1.1](https://github.com/opencontainers/image-spec) is [generally available](https://documentation.s3ns.fr/products/#product-launch-stages) in Docker format repositories.
