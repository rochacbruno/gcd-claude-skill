...
Cloud de Confiance console, select your preferred programming language:
...
[Take the C# tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--csharp-client-library)



[Take the Go tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--go-client-library)



[Take the Java tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--java-client-library)



[Take the Node.js tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--node-client-library)



[Take the PHP tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--php-client-library)



[Take the Python tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--python-client-library)



[Take the Ruby tour](https://console.cloud.s3nscloud.fr/?walkthrough_id=bigquery--ruby-client-library)
...
or to
[enable billing for your Cloud de Confiance project](/billing/docs/how-to/modify-project).
...
Activate your Cloud de Confiance project in Cloud Shell:
...
[ C# ](#c) [ Go ](#go) [ Java ](#java) [ Node.js ](#node.js) [ PHP ](#php) [ Python ](#python) [ Ruby ](#ruby) [ Rust ](#rust) 
More 
...
func query ( ctx context . Context , client * bigquery . Client ) ( * bigquery . [ RowIterator ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_RowIterator) , error ) { 
...
func printResults ( w io . Writer , iter * bigquery . [ RowIterator ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_RowIterator) ) error { 
for { 
...
import com.google.cloud.bigquery.[FieldValueList](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.FieldValueList.html) ; 
...
import com.google.cloud.bigquery.[TableResult](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableResult.html) ; 
...
[ QueryJobConfiguration ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.QueryJobConfiguration.html) . newBuilder ( 
...
[ JobId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.JobId.html) jobId = [ JobId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.JobId.html) . newBuilder (). setProject ( projectId ). build (); 
[ Job ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Job.html) queryJob = bigquery . [ create ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_create_com_google_cloud_bigquery_DatasetInfo_com_google_cloud_bigquery_BigQuery_DatasetOption____) ( JobInfo . newBuilder ( queryConfig ). setJobId ( jobId ). build ()); 

// Wait for the query to complete. 
queryJob = queryJob . [ waitFor ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Job.html#com_google_cloud_bigquery_Job_waitFor_com_google_cloud_bigquery_BigQueryRetryConfig_com_google_cloud_RetryOption____) (); 

// Check for errors 
if ( queryJob == null ) { 
throw new RuntimeException ( "Job no longer exists" ); 
} else if ( queryJob . getStatus (). [ getExecutionErrors ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.JobStatus.html#com_google_cloud_bigquery_JobStatus_getExecutionErrors__) () != null 
...
// Create a client 
const bigqueryClient = new [ BigQuery ](https://documentation.s3ns.fr/nodejs/docs/reference/bigquery/latest/bigquery/bigquery.html) (); 
...
results = client . [ query_and_wait ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html#google_cloud_bigquery_client_Client_query_and_wait) ( 
""" 
SELECT 
CONCAT( 
'https://stackoverflow.com/questions/', 
...
results . each do | row | 
puts " #{ [ row ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-bigquery/latest/Google-Cloud-Bigquery-InsertResponse-InsertError.html) [ :url ] } : #{ [ row ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-bigquery/latest/Google-Cloud-Bigquery-InsertResponse-InsertError.html) [ :view_count ] } views" 
end 
```
...
`bigquery-rust-quickstart` and a directory structure with `src/main.rs`.
...
Install the BigQuery client library and Tokio runtime for Rust:
...
In the **Explorer** pane, locate your `BIGQUERY-RUST-QUICKSTART`
project.

- 

Click the `src/main.rs` file to open it.
...
`bigquery-public-data.stackoverflow` dataset that returns the
top 10 most viewed Stack Overflow pages and their view counts, replace
the contents of the `src/main.rs` file with the following code:
...
In the terminal, run the program. If you are prompted to
authorize Cloud Shell and agree to the terms, click
**Authorize**.
...
You have successfully queried a public dataset with the
BigQuery Rust client library.



## Clean up

To avoid incurring charges to your Cloud de Confiance account, either delete
your Cloud de Confiance project, or delete the resources that you created in
this walkthrough.
...
[Go to Manage resources](https://console.cloud.s3nscloud.fr/iam-admin/projects)
...
Delete the `bigquery-rust-quickstart` folder that you created:
