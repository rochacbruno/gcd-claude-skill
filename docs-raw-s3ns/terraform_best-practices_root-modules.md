...
Source: https://documentation.s3ns.fr/docs/terraform/best-practices/root-modules
...
Terraform with Cloud de Confiance by S3NS, see [Get started with
...
When deploying services in Cloud de Confiance, split the Terraform
