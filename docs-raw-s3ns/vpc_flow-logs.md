...
Source: https://documentation.s3ns.fr/vpc/docs/flow-logs
...
[Learn how Cloud de Confiance by S3NS users strengthen their cyber
...
[Logging](/logging/docs) in the Cloud de Confiance project of the
...
Even though Cloud de Confiance doesn't capture every packet, log record captures
...
destination within Cloud de Confiance or the geographic region of external
...
- Flows can be within Cloud de Confiance or between Cloud de Confiance and
other networks.
