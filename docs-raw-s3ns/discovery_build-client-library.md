...
Source: https://documentation.s3ns.fr/docs/discovery/build-client-library
Last updated: 2025-06-16

Some or all of the information on this page might not apply to Cloud de Confiance by S3NS. See [Differences from Google Cloud](/docs/discovery/tpc-differences) for more details.
...
](https://documentation.s3ns.fr/docs/discovery)
...
[
Discovery document](https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1) for
[
the Service Usage API](https://documentation.s3ns.fr/service-usage/docs/reference/rest) is:
...
You don't need an [API key](https://documentation.s3ns.fr/docs/authentication/api-keys)
...
interface for interacting with the [Service Usage API](https://documentation.s3ns.fr/service-usage/docs/reference/rest), then
