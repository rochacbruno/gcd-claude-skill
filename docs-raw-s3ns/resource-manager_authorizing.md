...
Source: https://documentation.s3ns.fr/resource-manager/docs/authorizing
...
- When you create your application, you register it using the [Cloud de Confiance console](https://console.cloud.s3nscloud.fr/). Google then provides information you'll need later, such as a client ID and a
client secret.

- Activate the Cloud Resource Manager API in the Cloud de Confiance console. (If the API isn't listed in the Cloud de Confiance console, then skip this step.)
...
- Open the [Credentials page](https://console.cloud.s3nscloud.fr/apis/credentials) in the Cloud de Confiance console.
...
](https://console.cloud.s3nscloud.fr/apis/credentials) > API key**. You can restrict the key before using it
