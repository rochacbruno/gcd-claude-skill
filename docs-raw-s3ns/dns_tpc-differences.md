# Cloud DNS in Cloud de Confiance versus Google Cloud

Source: https://documentation.s3ns.fr/dns/docs/tpc-differences
...
Cloud de Confiance and Google Cloud versions of Cloud DNS.
...
There are some differences between the Cloud de Confiance version of Cloud DNS and
...
- Only private DNS zones are available in Cloud de Confiance by S3NS. Public DNS zones aren't supported.
