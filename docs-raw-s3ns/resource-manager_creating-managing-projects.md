...
Source: https://documentation.s3ns.fr/resource-manager/docs/creating-managing-projects
...
Projects are the fundamental operating unit in the Cloud de Confiance by S3NS resource
...
Cloud de Confiance projects using the Cloud Resource Manager API and the Cloud de Confiance console.
...
Cloud de Confiance by S3NS services (APIs) are enabled and where resources like
...
[Decide a resource hierarchy for your Cloud de Confiance landing zone](/architecture/landing-zones/decide-resource-hierarchy).
...
others in Cloud de Confiance by S3NS. After you enter a project name, the
Cloud de Confiance console generates a unique project ID that can be a
...
resource names. The project ID appears in the name of many other Cloud de Confiance by S3NS
...
You can create a new project using the Cloud de Confiance console, the
Google Cloud CLI, or
...
visual indicator to the project in the Cloud de Confiance console project picker
...
a support ticket with the Cloud de Confiance by S3NS team. For details,
