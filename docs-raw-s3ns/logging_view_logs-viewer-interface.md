...
Source: https://documentation.s3ns.fr/logging/docs/view/logs-viewer-interface
...
- [ Get Cloud de Confiance project or organization ID ](#getting-project_organization_id)
...
Cloud de Confiance console, which you can use to retrieve, view, and analyze log entries
...
Select a Cloud de Confiance project, folder, or organization.
...
users of the Cloud de Confiance project have shared with you. For more
information, see
...
your Cloud de Confiance project. For more information, see
[Use suggested queries](/logging/docs/view/building-queries#suggested_queries).

- 

Queries provided by Cloud de Confiance by S3NS: View queries provided by Cloud de Confiance by S3NS
based on common use cases for various Cloud de Confiance services. For more
...
users who have access to the Cloud de Confiance project. When a user pastes the
link into a browser or selects it, Logging pins the log entry in
their **Query results** pane.

## Example Logs Explorer queries

For suggested queries, arranged by Cloud de Confiance product and use case, see
...
[Go to **VM instances**](https://console.cloud.s3nscloud.fr/compute/instances)
...
### Get Cloud de Confiance project or organization ID

To get a Cloud de Confiance project or organization ID from anywhere in the
Cloud de Confiance console, expand the list of Cloud de Confiance projects from the
Cloud de Confiance project and organization selector and find the
Cloud de Confiance project ID in the **ID** column.
...
Verify that the correct Cloud de Confiance project is selected.

- 

Verify that your Cloud de Confiance project is using resources that generate
logs and that there
is activity on those resources. Even if the Cloud de Confiance project is
...
Cloud Logging uses the history of the sinks in the Cloud de Confiance project to
