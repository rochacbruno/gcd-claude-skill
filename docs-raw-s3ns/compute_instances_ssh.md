...
Source: https://documentation.s3ns.fr/compute/docs/instances/ssh
...
use the Cloud de Confiance console or the Google Cloud CLI to connect to your VMs,
...
before it grants SSH connections when you use the Cloud de Confiance console, the
gcloud CLI, or third-party tools to connect to VMs. If you connect to
VMs without using the Cloud de Confiance console or the gcloud CLI, you must
...
Cloud de Confiance console](https://console.cloud.s3nscloud.fr/compute/instances) to [connect
