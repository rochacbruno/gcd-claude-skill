...
Source: https://documentation.s3ns.fr/docs/quotas/quota-project
...
You must specify a quota project because every request to a Cloud de Confiance by S3NS API is
