...
](https://documentation.s3ns.fr/storage/docs/resources)
...
[feed URL](https://documentation.s3ns.fr/feeds/storage-release-notes.xml) directly.
...
available](https://documentation.s3ns.fr/products#product-launch-stages). You can
...
[generally available](https://documentation.s3ns.fr/products#product-launch-stages).
...
[Pub/Sub notifications for Cloud Storage](https://documentation.s3ns.fr/storage/docs/migrate-to-pub-sub-notifications) instead.
