...
Source: https://documentation.s3ns.fr/docs/authentication/set-up-adc-attached-service-account
...
Some Cloud de Confiance services—such as Compute Engine, App Engine, and
