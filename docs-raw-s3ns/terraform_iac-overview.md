...
- [ IaC tools for Cloud de Confiance ](#iac-usecases-tools)
...
In general, to configure and manage Cloud de Confiance infrastructure using
code, use the Terraform provider for Cloud de Confiance.
...
[Overview of Terraform on Cloud de Confiance](/docs/terraform/terraform-overview).
...
provision Cloud de Confiance infrastructure and lets you use your existing
...
languages. You can use Cloud de Confiance provider for Pulumi to author
...
Another option to manage Cloud de Confiance resources through Kubernetes is
by using Crossplane.
...
like Cloud de Confiance. If something modifies or deletes a resource outside
...
Cloud de Confiance](https://docs.ansible.com/ansible/latest/collections/google/cloud/).

## What's next

- Learn about the [differences in Cloud de Confiance versus Google Cloud](/docs/terraform/tpc-differences)
