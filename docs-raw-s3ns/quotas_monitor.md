...
Source: https://documentation.s3ns.fr/docs/quotas/monitor
...
[Go to **Metrics explorer**](https://console.cloud.s3nscloud.fr/monitoring/metrics-explorer)

If you use the search bar to find this page, then select the result whose subheading is
**Monitoring**.


- In the toolbar of the Cloud de Confiance console, select your Cloud de Confiance project.
...
using either the Cloud de Confiance console or gcloud CLI.
...
[Google Cloud Observability pricing](https://documentation.s3ns.fr/stackdriver/pricing)
document.
...
- [Cloud de Confiance by S3NS metrics guide](/monitoring/api/metrics_gcp_p_z#gcp-serviceruntime):
