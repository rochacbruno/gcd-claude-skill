...
`service- PROJECT_NUMBER @gcp-sa-apigeeregistry.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datalabeling.s3ns-system.iam.gserviceaccount.com`
