...
](https://documentation.s3ns.fr/iam/docs/apis)
...
Some Cloud de Confiance by S3NS services have [*service agents*](/iam/docs/service-account-types#service-agents) that allow
the service to access your resources. If an API requires a service agent, then
Cloud de Confiance creates the service agent at some point after you activate
...
about when Cloud de Confiance creates service agents, see [Service agent
...
When the service agent is created, Cloud de Confiance grants this role
automatically.

Cloud de Confiance can introduce new service agents at any time, both for
...
`service- PROJECT_NUMBER @gcp-sa-vertex-es.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform-ft.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform-is.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform-pie.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-eval.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform-re.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-ri-aiplatform.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apihub.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apikeys.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apim.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-meshcontrolplane.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-meshdataplane.s3ns-system.iam.gserviceaccount.com`
...
- `service-p PROJECT_NUMBER @gcp-sa-accessapproval.s3ns-system.iam.gserviceaccount.com`
...
- `service-f FOLDER_NUMBER @gcp-sa-accessapproval.s3ns-system.iam.gserviceaccount.com`
...
- `service-o ORGANIZATION_NUMBER @gcp-sa-accessapproval.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-adsdatahub.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-agentgateway.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-agentregistry.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-alloydb.s3ns-system.iam.gserviceaccount.com`
...
`c- PROJECT_NUMBER - IDENTIFIER @gcp-sa-alloydb.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-analyticshub.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthosaudit.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthosconfigmanagement.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthosidentityservice.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkemulticloudcontainer.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkemulticloudcpmachine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkemulticloudnpmachine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkemulticloud.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthospolicycontroller.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthos.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-servicemesh.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-anthossupport.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apigee.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-appdevexperience.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gae-api-prod.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-gae-service.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apphub.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-appoptimize.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-integrations.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-artifactregistry.s3ns-system.iam.gserviceaccount.com`
...
`service-folder- FOLDER_NUMBER @gcp-sa-assuredworkloads.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-assuredworkloads.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-asm-hpsa.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-audit-manager.s3ns-system.iam.gserviceaccount.com`
...
- `service-folder- FOLDER_NUMBER @gcp-sa-audit-manager.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-audit-manager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-autoannotate.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-recommendationengine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-backupdr-run.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-backupdr.s3ns-system.iam.gserviceaccount.com`
...
`vault- PROJECT_NUMBER - IDENTIFIER @gcp-sa-backupdr-pr.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkebackup.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bms.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudbatch.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-connectedsheets.s3ns-system.iam.gserviceaccount.com`
...
- `bqcx- PROJECT_NUMBER - IDENTIFIER @gcp-sa-bigquery-condel.s3ns-system.iam.gserviceaccount.com`

- `connection- PROJECT_NUMBER - IDENTIFIER @gcp-sa-bigquery-condel.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bigquerytardis.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bqms.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-prod-bigqueryomni.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bigqueryri.s3ns-system.iam.gserviceaccount.com`
...
`bqcx- PROJECT_NUMBER - IDENTIFIER @gcp-sa-bigquery-consp.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bigqueryspark.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-binaryauthorization.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bne.s3ns-system.iam.gserviceaccount.com`
...
`b PROJECT_NUMBER - IDENTIFIER @gcp-sa-bundles.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-businessaicode.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-chronicle-org.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-chronicle.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-chronicle-soar.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-notebooks.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-notebooks-vm.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apigateway-mgmt.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-apigateway.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-effectivepolicy.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-othercloudcfg.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudasset.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-bigtable.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudbuild.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-certificatemanager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloudcomposer-accounts.s3ns-system.iam.gserviceaccount.com`
...
`service-folder- FOLDER_NUMBER @gcp-sa-cloudcontrolspartner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dns.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datafusion.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @dlp-api.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datamigration.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @dataflow-service-producer-prod.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datastream.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-clouddeploy.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-endpoints.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloud-filer.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firestore.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-healthcare.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-identitytoolkit.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-cloudkms.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudkms.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
- `service-folder- FOLDER_NUMBER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-mi.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloud-memcache-sa.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloud-redis.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-migcenter.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-networkmanagement.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-notebooksecurityscanner.s3ns-system.iam.gserviceaccount.com`
...
- `service- PROJECT_NUMBER @gcp-sa-nss-hpsa.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-nss-hpsa.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-observability.s3ns-system.iam.gserviceaccount.com`
...
- `service-folder- FOLDER_NUMBER @gcp-sa-observability.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-observability.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-routeoptim.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-cloudresourcemanager.s3ns-system.iam.gserviceaccount.com`
...
`organizations- ORGANIZATION_NUMBER @gcp-sa-riskmanager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloud-sql.s3ns-system.iam.gserviceaccount.com`
...
- `p PROJECT_NUMBER - IDENTIFIER @gcp-sa-cloud-sql.s3ns-system.iam.gserviceaccount.com`
...
- `f FOLDER_NUMBER - IDENTIFIER @gcp-sa-cloud-sql.s3ns-system.iam.gserviceaccount.com`
...
- `o ORGANIZATION_NUMBER - IDENTIFIER @gcp-sa-cloud-sql.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudscheduler.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-scc-bulk-export.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-scc-notification.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-scc-notification.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-securitycenter.s3ns-system.iam.gserviceaccount.com`
...
- `service- PROJECT_NUMBER @security-center-api.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @security-center-api.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-csc-hpsa.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-csc-hpsa.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-spanner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebasestorage.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudtasks.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloud-trace.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-translation.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vmmigration.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-websecurityscanner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-workflows.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-workstations.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-hypercomputecluster.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-compute-usage.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-configdelivery.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-connectors.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-contactcenterinsights.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ccinsights-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ccaip.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ccai-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-ri-contactcenterinsights.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @container-analysis.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-containerscanning.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-containersec.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ktd-control.s3ns-system.iam.gserviceaccount.com`
...
- `service- PROJECT_NUMBER @gcp-sa-ktd-hpsa.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-ktd-hpsa.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloud-cw.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ces.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dataconnectors.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datalineage.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datapipelines.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datastudio-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-datastudio.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dbinsights.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-dataplex-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-dataplex.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-metastore.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-monitoring.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-designcenter.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-devconnect.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-devicerun.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dialogflow-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dialogflow.s3ns-system.iam.gserviceaccount.com`
...
`service-workspace-C GOOGLE_WORKSPACE_CUSTOMER_ID @gcp-sa-discoveryengine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-discoveryengine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloud-cw-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-prod-dai-core.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-edgecontainercluster.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-edgecontainergcr.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-edgecontainer.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloud-ekg.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-eventarc.s3ns-system.iam.gserviceaccount.com`
...
Service agent for `ftp.googleapis.com`. 


`p- PROJECT_NUMBER - IDENTIFIER @gcp-sa-ftp.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebasevertexai.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebaseappcheck.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebaseapphosting.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-crashlytics.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebasedataconnect.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebasemods.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebaseml.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebase.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firebasedatabase.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @firebase-rules.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-firewallinsights.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gsuiteaddons.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gcs-malware.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-storage-search.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkedataplanev2.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkehub.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-geminicodeassistmp.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-geminidataanalytics.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-cloudaicompanion.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-generativelanguage.s3ns-system.iam.gserviceaccount.com`
...
`p- PROJECT_NUMBER - IDENTIFIER @gcp-sa-generativelanguage.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkeonprem.s3ns-system.iam.gserviceaccount.com`
...
Service agent used internally by Cloud de Confiance. 
...
`service- PROJECT_NUMBER @gcp-sa-dataprocrmnode.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @dataproc-accounts.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcf-admin-robot.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloud-ml.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-netapp.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ns-authz.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-run-ai.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @serverless-robot-prod.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-dep.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @containerregistry.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-iap.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-ri-identitypool.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-global-spanner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-config.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ivs.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-fs-spanner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-krmapihosting.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-krmapihosting-dataplane.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-gkenode.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-livestream.s3ns-system.iam.gserviceaccount.com`
...
- `p PROJECT_NUMBER - IDENTIFIER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
- `f FOLDER_NUMBER - IDENTIFIER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
- `o ORGANIZATION_NUMBER - IDENTIFIER @gcp-sa-logging.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-looker.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-lustre.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-managedflink.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-managedkafka.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-memorystore.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-meshconfig.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-modelarmor.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-monitoring-notification.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-multiclusteringress.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-mcmetering.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-mcsd.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-networkactions.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-networkconnectivity.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-networksecurity.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-ondemandscanning.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-oci.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-parallelstore.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-pm.s3ns-system.iam.gserviceaccount.com`
...
- `p PROJECT_NUMBER - IDENTIFIER @gcp-sa-playbooks.s3ns-system.iam.gserviceaccount.com`
...
- `f FOLDER_NUMBER - IDENTIFIER @gcp-sa-playbooks.s3ns-system.iam.gserviceaccount.com`
...
- `o ORGANIZATION_NUMBER - IDENTIFIER @gcp-sa-playbooks.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-v1-remediator.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-privateca.s3ns-system.iam.gserviceaccount.com`
...
- `service- PROJECT_NUMBER @gcp-sa-pam.s3ns-system.iam.gserviceaccount.com`
...
- `service-folder- FOLDER_NUMBER @gcp-sa-pam.s3ns-system.iam.gserviceaccount.com`
...
- `service-org- ORGANIZATION_NUMBER @gcp-sa-pam.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-pubsublite.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-rma.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-rbe.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @remotebuildexecution.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-remotebuild.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-retail.s3ns-system.iam.gserviceaccount.com`
...
`service-org- ORGANIZATION_NUMBER @gcp-sa-sccspanner.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-saasservicemgmt.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-secretmanager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-sourcemanager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-securewebproxy.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-runapps.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vpcaccess.s3ns-system.iam.gserviceaccount.com`
...
`service-agent-manager@s3ns-system.system.gserviceaccount.com`
...
`service- PROJECT_NUMBER @service-consumer-management.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @service-networking.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-skills.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-spectrumsas.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-speech.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-storageinsights.s3ns-system.iam.gserviceaccount.com`
...
`project- PROJECT_NUMBER @storage-transfer-service.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-stream.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @cloud-tpu.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-tpu.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-transcoder.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-transferappliance.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vmwareengine.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vs-cmek.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vectorsearch.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-sandbox.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-shtune.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-bp.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-nb.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-ex.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-ex-cc.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-logging.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-moss-ft.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-mm.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-aiplatform-vm.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-op.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-tune.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-telemetry.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-vtc.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-agent.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-vertex-rag.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-scc-vmtd.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-visionai.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-workloadmanager.s3ns-system.iam.gserviceaccount.com`
...
`service- PROJECT_NUMBER @gcp-sa-workstationsvm.s3ns-system.iam.gserviceaccount.com`
