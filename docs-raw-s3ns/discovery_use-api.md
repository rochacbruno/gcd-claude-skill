...
Source: https://documentation.s3ns.fr/docs/discovery/use-api
...
[Service Usage API](https://documentation.s3ns.fr/service-usage/docs/reference/rest).
You can load the
[Discovery document](https://serviceusage.s3nsapis.fr/$discovery/rest?version=v1)
...
"revision" : "20240331" , 
"servicePath" : "" , 
"baseUrl" : "https://serviceusage.s3nsapis.fr/" , 
...
"discoveryVersion" : "v1" , 
"rootUrl" : "https://serviceusage.s3nsapis.fr/" , 
"protocol" : "rest" 
```
