# Authentication for Cloud de Confiance by S3NS APIs and services

Source: https://documentation.s3ns.fr/docs/authentication
...
- [ Authorization methods for Cloud de Confiance services ](#authorization-gcp)
...
Authenticate to a Cloud de Confiance service from my application using
...
Try out some Cloud de Confiance REST API
...
When you access Cloud de Confiance by S3NS services by using the Google Cloud CLI, Cloud Client Libraries,
tools that support
[
...
- Are you running code in Cloud de Confiance by S3NS?
...
## Authorization methods for Cloud de Confiance services

Authorization for Cloud de Confiance is primarily handled by
...
authenticate to a Cloud de Confiance service, you can use a global scope that
authorizes access to *all* Cloud de Confiance services
...
API reference documentation for each Cloud de Confiance service.
...
changing how your application authenticates to Cloud de Confiance by S3NS services and APIs.
...
Cloud de Confiance APIs when running on a development workstation or on
Compute Engine.
...
service account ([Preview](https://documentation.s3ns.fr/products#product-launch-stages)).
...
access Cloud de Confiance services.
...
needs to access Cloud de Confiance resources. Service accounts are managed by
IAM.
...
accounts, for Cloud de Confiance by S3NS,
...
Cloud de Confiance identity and access products enable access to
Cloud de Confiance services and resources for both programmatic access and human
users. Cloud de Confiance uses the terms *workload* for programmatic access and
...
- Learn more about how Cloud de Confiance services
[use IAM to control access to Cloud de Confiance resources](/iam/docs/overview).
