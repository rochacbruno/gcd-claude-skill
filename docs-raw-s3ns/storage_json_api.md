...
Source: https://documentation.s3ns.fr/storage/docs/json_api
...
](https://documentation.s3ns.fr/storage/docs/apis)
...
[Cloud de Confiance console Quickstart](/storage/docs/discover-object-storage-console) or the [Google Cloud CLI Quickstart](/storage/docs/discover-object-storage-gcloud).
...
```
https://storage.s3nsapis.fr/storage/v1/b/my-bucketT/o/my-object? fields=id,name,metadata/key1**
```
...
```
POST https://storage.s3nsapis.fr/...
...
```
PATCH https://storage.s3nsapis.fr/storage/v1/b/ BUCKET_NAME /o/ OBJECT_NAME 
...
```
https://storage.s3nsapis.fr/storage/v1/b/ BUCKET_NAME /o/ OBJECT_NAME ? QUERY_PARAMETER = VALUE 
```
...
```
https://storage.s3nsapis.fr/storage/v1/b/ BUCKET_NAME /o/ OBJECT_NAME ? QUERY_PARAMETER = VALUE & QUERY_PARAMETER_2 = VALUE_2 
```
