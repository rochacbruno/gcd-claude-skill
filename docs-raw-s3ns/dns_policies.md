...
The Cloud DNS API requires that you create a Cloud de Confiance project and enable the
Cloud DNS API.
...
In the Cloud de Confiance console, open the **Cloud DNS server policies** page.

[Go to Cloud DNS server policies](https://console.cloud.s3nscloud.fr/networking/dns/policies)
...
Cloud de Confiance firewall rules do *not* apply to the regional internal
