...
Source: https://documentation.s3ns.fr/docs/get-started/learn-about-billing
...
understand, pay for, and optimize your costs on Cloud de Confiance by S3NS and
Google Maps Platform.

- 

**Required for all services**: You must have an active Cloud Billing
account linked to your Cloud de Confiance by S3NS projects to use any Cloud de Confiance by S3NS
...
Cloud de Confiance by S3NS resources. It's linked to a Google Payments profile. You
...
- Cloud de Confiance by S3NS projects: Your resources (like virtual machines, storage,
...
Cloud de Confiance by S3NS uses Identity and Access Management (IAM) to control access to Cloud Billing.
...
permissions](https://documentation.s3ns.fr/billing/docs/how-to/billing-access). You
can also [Create custom roles for
Cloud Billing](https://documentation.s3ns.fr/billing/docs/how-to/custom-roles).

### View your costs

The Cloud de Confiance console provides [several tools](/billing/docs/reports)
...
alerts](https://documentation.s3ns.fr/billing/docs/how-to/budgets).
