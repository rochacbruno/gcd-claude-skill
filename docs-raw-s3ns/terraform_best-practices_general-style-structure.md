...
Source: https://documentation.s3ns.fr/docs/terraform/best-practices/general-style-structure
...
units (such as `ram_size_gb`). Cloud de Confiance APIs don't have standard
...
matches the usage within Cloud de Confiance.
