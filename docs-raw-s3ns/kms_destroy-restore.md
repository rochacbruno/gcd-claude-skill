...
[ CryptoKeyVersion ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.CryptoKeyVersion.html) response = client . destroyCryptoKeyVersion ( keyVersionName ); 
System . out . printf ( "Destroyed key version: %s%n" , response . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.CryptoKeyVersion.html#com_google_cloud_kms_v1_CryptoKeyVersion_getName__) ()); 
} 
} 
} 
```
...
systems](https://documentation.s3ns.fr/docs/security/deletion#stage_3_-_logical_deletion_from_active_systems)
...
key version in Cloud de Confiance by S3NS. After the Cloud EKM key version is
...
destroys the key version in Cloud de Confiance, and then sends a destruction
...
// Build the key version name. 
[ CryptoKeyVersionName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Kms.V1/latest/Google.Cloud.Kms.V1.CryptoKeyVersionName.html) cryptoKeyVersionName = new [ CryptoKeyVersionName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Kms.V1/latest/Google.Cloud.Kms.V1.CryptoKeyVersionName.html) ( projectId , locationId , keyRingId , keyId , keyVersionId ); 

// Call the API. 
[ CryptoKeyVersion ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Kms.V1/latest/Google.Cloud.Kms.V1.CryptoKeyVersion.html) result = client . [ RestoreCryptoKeyVersion ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Kms.V1/latest/Google.Cloud.Kms.V1.KeyManagementServiceClient.html#Google_Cloud_Kms_V1_KeyManagementServiceClient_RestoreCryptoKeyVersion_Google_Cloud_Kms_V1_CryptoKeyVersionName_Google_Api_Gax_Grpc_CallSettings_) ( cryptoKeyVersionName ); 
...
[ CryptoKeyVersion ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.CryptoKeyVersion.html) response = client . restoreCryptoKeyVersion ( keyVersionName ); 
System . out . printf ( "Restored key version: %s%n" , response . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-kms/latest/com.google.cloud.kms.v1.CryptoKeyVersion.html#com_google_cloud_kms_v1_CryptoKeyVersion_getName__) ()); 
} 
} 
} 
```
...
[Cloud de Confiance deletion timeline](https://documentation.s3ns.fr/docs/security/deletion#deletion_timeline)
of 180 days.