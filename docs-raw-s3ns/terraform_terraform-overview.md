# Overview of Terraform on Cloud de Confiance

Source: https://documentation.s3ns.fr/docs/terraform/terraform-overview
...
provision and manage Cloud de Confiance infrastructure.

## Benefits of using Terraform 

This section explains some of the benefits of using Terraform to provision and
manage Cloud de Confiance infrastructure:

- Terraform is the most commonly used tool to provision and automate
Cloud de Confiance infrastructure. You can use the
[Google Cloud provider](https://registry.terraform.io/providers/hashicorp/google/latest/docs)
to configure and manage all Cloud de Confiance resources using the same
...
- You describe the Cloud de Confiance infrastructure you want to provision
...
There are two providers that let you provision and manage Cloud de Confiance
infrastructure:
...
- Learn about [Terraform differences in Cloud de Confiance versus Google Cloud](/docs/terraform/tpc-differences)
