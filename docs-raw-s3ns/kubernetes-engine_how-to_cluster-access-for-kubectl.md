...
configuration is required if you run multiple clusters in Cloud de Confiance by S3NS.
...
common roles and example tasks that are referenced in Cloud de Confiance by S3NS documentation,
...
When you create a cluster using the Cloud de Confiance console or using gcloud CLI from a
...
- [Authenticate to Cloud de Confiance services from GKE workloads](/kubernetes-engine/docs/how-to/workload-identity).
