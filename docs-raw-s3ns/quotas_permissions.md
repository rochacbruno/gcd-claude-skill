...
Source: https://documentation.s3ns.fr/docs/quotas/permissions
...
To view your project quota in the Cloud de Confiance console or to access your project
...
To view quota increase requests in the Cloud de Confiance console, you must have the
