# Authenticate to Cloud de Confiance APIs from GKE workloads

Source: https://documentation.s3ns.fr/kubernetes-engine/docs/how-to/workload-identity
...
](https://documentation.s3ns.fr/kubernetes-engine/docs/concepts/security-overview)
...
This page shows you how to more securely access Cloud de Confiance APIs from
...
reference in Cloud de Confiance by S3NS content, see
...
](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=container.googleapis.com)
...
- Ensure that the Cloud de Confiance APIs that you want to access are supported
...
[Enable
IAM Credentials API](https://console.cloud.s3nscloud.fr/apis/api/iamcredentials.googleapis.com/overview)
...
pools using the Google Cloud CLI or the Cloud de Confiance console.
...
using the gcloud CLI or the Cloud de Confiance console. Existing node pools
...
Go to the **Google Kubernetes Engine** page in Cloud de Confiance console.

[Go to Google Kubernetes Engine](https://console.cloud.s3nscloud.fr/kubernetes/list)
...
To let your GKE applications authenticate to Cloud de Confiance
...
Cloud de Confiance resources that your application needs to access. You must
...
- ` PROJECT_NUMBER `: your numerical Cloud de Confiance
project number.

You can grant roles on any Cloud de Confiance resource that supports
...
supported Cloud de Confiance API. If these limitations apply to you, use the
...
For information on authorizing IAM service accounts to access Cloud de Confiance by S3NS
...
specific Cloud de Confiance APIs:
...
name. For example, `serviceAccount:example-project.s3ns.svc.id.goog[example-namespace/example-serviceaccount]`.
...
Authenticating to Cloud de Confiance services from your code is the same process
...
using the [Cloud de Confiance client libraries](/docs/authentication/client-libraries))
...
from a different Cloud de Confiance project when making calls to
...
in the Cloud de Confiance console for your quota project:

[Go to APIs](https://console.cloud.s3nscloud.fr/apis/api/iamcredentials.googleapis.com/metrics)
