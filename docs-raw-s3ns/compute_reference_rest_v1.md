...
The method `compute. v1. Accelerator Types Service. Aggregated List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute. v1. Accelerator Types Service. Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute. v1. Accelerator Types Service. List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AutoscalersService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.AddSignedUrlKey` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.DeleteSignedUrlKey` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.SetEdgeSecurityPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendBucketsService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.AddSignedUrlKey` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.DeleteSignedUrlKey` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.GetHealth` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.ListUsable` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.SetEdgeSecurityPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.SetSecurityPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.BackendServicesService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DiskTypesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DiskTypesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DiskTypesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.AddResourcePolicies` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.BulkInsert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.CreateSnapshot` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.RemoveResourcePolicies` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.Resize` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.StartAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.StopAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.StopGroupAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.DisksService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.AddAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.AddRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.CloneRules` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.GetAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.GetOrganizationPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.GetRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.ListAssociations` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.Move` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.PatchRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.RemoveAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.RemoveRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.SetOrganizationPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallPoliciesService.TestOrganizationPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.FirewallsService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionForwardingRulesService.SetTarget` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.Move` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalAddressesService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalForwardingRulesService.SetTarget` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.AttachNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.DetachNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalNetworkEndpointGroupsService.ListNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOperationsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOperationsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOperationsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOperationsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOperationsService.Wait` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOrganizationOperationsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOrganizationOperationsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalOrganizationOperationsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalPublicDelegatedPrefixesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalPublicDelegatedPrefixesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalPublicDelegatedPrefixesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalPublicDelegatedPrefixesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.GlobalPublicDelegatedPrefixesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HealthChecksService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpHealthChecksService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.HttpsHealthChecksService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ImageFamilyViewsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupManagerResizeRequestsService.Cancel` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupManagerResizeRequestsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupManagerResizeRequestsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupManagerResizeRequestsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupManagerResizeRequestsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.AddInstances` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.ListInstances` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.RemoveInstances` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceGroupsService.SetNamedPorts` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceSettingsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstanceSettingsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InstantSnapshotsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectAttachmentsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectRemoteLocationsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectRemoteLocationsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.GetDiagnostics` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.GetMacsecConfig` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.InterconnectsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkAttachmentsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEdgeSecurityServicesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEdgeSecurityServicesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEdgeSecurityServicesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEdgeSecurityServicesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEdgeSecurityServicesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.AttachNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.DetachNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.ListNetworkEndpoints` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworkEndpointGroupsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.AddPeering` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.GetEffectiveFirewalls` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.ListPeeringRoutes` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.RemovePeering` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.SwitchToCustomMode` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NetworksService.UpdatePeering` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NodeTypesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NodeTypesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.NodeTypesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PacketMirroringsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.DisableXpnHost` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.DisableXpnResource` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.EnableXpnHost` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.EnableXpnResource` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.GetXpnHost` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.GetXpnResources` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.ListXpnHosts` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.MoveDisk` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.MoveInstance` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.SetCloudArmorTier` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.SetCommonInstanceMetadata` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.SetDefaultNetworkTier` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ProjectsService.SetUsageExportBucket` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Announce` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicAdvertisedPrefixesService.Withdraw` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Announce` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.PublicDelegatedPrefixesService.Withdraw` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionAutoscalersService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDiskTypesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDiskTypesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.AddResourcePolicies` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.BulkInsert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.CreateSnapshot` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.RemoveResourcePolicies` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.Resize` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.StartAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.StopAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.StopGroupAsyncReplication` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionDisksService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionHealthCheckServicesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionHealthCheckServicesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionHealthCheckServicesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionHealthCheckServicesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionHealthCheckServicesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceGroupsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceGroupsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceGroupsService.ListInstances` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceGroupsService.SetNamedPorts` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceTemplatesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceTemplatesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceTemplatesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstanceTemplatesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstancesService.BulkInsert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionInstantSnapshotsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.AddAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.AddRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.CloneRules` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.GetAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.GetEffectiveFirewalls` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.GetRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.PatchRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.RemoveAssociation` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.RemoveRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionNetworkFirewallPoliciesService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionOperationsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionOperationsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionOperationsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionOperationsService.Wait` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslCertificatesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslCertificatesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslCertificatesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslCertificatesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.ListAvailableFeatures` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionSslPoliciesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpProxiesService.SetUrlMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.SetSslCertificates` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetHttpsProxiesService.SetUrlMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetTcpProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetTcpProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetTcpProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionTargetTcpProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionZonesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.Resize` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.AllocationsService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.GetNatIpInfo` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.GetNatMappingInfo` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.GetRouterStatus` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Preview` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RegionRoutersService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RoutesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RoutesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RoutesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.RoutesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.AddRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.GetRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.ListPreconfiguredExpressionSets` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.PatchRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.RemoveRule` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SecurityPoliciesService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.ServiceAttachmentsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotSettingsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotSettingsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SnapshotsService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SslCertificatesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SslCertificatesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SslCertificatesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SslCertificatesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SslCertificatesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.ExpandIpCidrRange` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.GetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.ListUsable` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.SetPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.SetPrivateIpGoogleAccess` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.SubnetworksService.TestPermissions` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetGrpcProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetGrpcProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetGrpcProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetGrpcProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetGrpcProxiesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpProxiesService.SetUrlMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.SetCertificateMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.SetQuicOverride` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.SetSslCertificates` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.SetSslPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetHttpsProxiesService.SetUrlMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetInstancesService.SetSecurityPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.SetBackendService` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.SetCertificateMap` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.SetProxyHeader` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.SetSslCertificates` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetSslProxiesService.SetSslPolicy` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.SetBackendService` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.TargetTcpProxiesService.SetProxyHeader` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.InvalidateCache` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Patch` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Update` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.UrlMapsService.Validate` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.AggregatedList` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.Delete` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.Get` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.Insert` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.List` is not available in this (s3nsapis.fr) universe. | 
|
...
The method `compute.v1.VpnTunnelsService.SetLabels` is not available in this (s3nsapis.fr) universe. | 
|
