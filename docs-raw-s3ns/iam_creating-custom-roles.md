...
[Enable the API](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=iam.googleapis.com&redirect=https%3A//console.cloud.google.com)
...
Understand the Cloud de Confiance by S3NS [resource hierarchy](/iam/docs/overview#resource-hierarchy).
...
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html).[QueryTestablePermissionsPagedResponse](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.QueryTestablePermissionsPagedResponse.html) ; 
import com.google.iam.admin.v1.[QueryTestablePermissionsRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.QueryTestablePermissionsRequest.html) ; 
...
[ QueryTestablePermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.QueryTestablePermissionsRequest.html) queryTestablePermissionsRequest = 
[ QueryTestablePermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.QueryTestablePermissionsRequest.html) . newBuilder (). setFullResourceName ( fullResourceName ). build (); 
...
[ QueryTestablePermissionsPagedResponse ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.QueryTestablePermissionsPagedResponse.html) queryTestablePermissionsPagedResponse = 
...
client = [ resourcemanager_v3 ](https://documentation.s3ns.fr/python/docs/reference/cloudresourcemanager/latest) . [ ProjectsClient ](https://documentation.s3ns.fr/python/docs/reference/cloudresourcemanager/latest/google.cloud.resourcemanager_v3.services.projects.ProjectsClient.html) () 
request = iam_policy_pb2 . TestIamPermissionsRequest () 
request . resource = f "projects/ { project_id } " 
request . permissions . extend ( permissions ) 

permissions_reponse = client . [ test_iam_permissions ](https://documentation.s3ns.fr/python/docs/reference/cloudresourcemanager/latest/google.cloud.resourcemanager_v3.services.projects.ProjectsClient.html#google_cloud_resourcemanager_v3_services_projects_ProjectsClient_test_iam_permissions) ( request ) 
...
In the Cloud de Confiance console go to the **Roles** page.

[
Go to the Roles page](https://console.cloud.s3nscloud.fr/iam-admin/roles)
...
```
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) ; 
import com.google.iam.admin.v1.[GetRoleRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.GetRoleRequest.html) ; 
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) ; 
import java.io.IOException ; 
...
[ GetRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.GetRoleRequest.html) getRoleRequest = [ GetRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.GetRoleRequest.html) . newBuilder (). setName ( roleId ). build (); 

// Initialize client for sending requests. This client only needs to be created 
// once, and can be reused for multiple requests. 
try ( [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) iamClient = [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) . create ()) { 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) role = iamClient . getRole ( getRoleRequest ); 
role . [ getIncludedPermissionsList ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html#com_google_iam_admin_v1_Role_getIncludedPermissionsList__) (). forEach ( permission - > System . out . println ( permission )); 
} 
} 
} 
```
...
from google.cloud.iam_admin_v1 import [ GetRoleRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.GetRoleRequest.html) , [ IAMClient ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html) , [ Role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.html)
...
try : 
role = client . [ get_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_get_role) ( request ) 
...
```
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) ; 
import com.google.iam.admin.v1.[CreateRoleRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.CreateRoleRequest.html) ; 
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) ; 
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html).[RoleLaunchStage](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.RoleLaunchStage.html) ; 
import java.io.IOException ; 
...
String roleId ) 
throws IOException { 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) . Builder roleBuilder = 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) . newBuilder () 
. setTitle ( title ) 
. setDescription ( description ) 
. [ addAllIncludedPermissions ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.Builder.html#com_google_iam_admin_v1_Role_Builder_addAllIncludedPermissions_java_lang_Iterable_java_lang_String__) ( includedPermissions ) 
// See launch stage enums at 
// https://cloud.google.com/iam/docs/reference/rpc/google.iam.admin.v1#rolelaunchstage 
. setStage ( [ RoleLaunchStage ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.RoleLaunchStage.html) . BETA ); 
[ CreateRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.CreateRoleRequest.html) createRoleRequest = 
[ CreateRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.CreateRoleRequest.html) . newBuilder () 
. setParent ( "projects/" + projectId ) 
. [ setRoleId ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.CreateRoleRequest.Builder.html#com_google_iam_admin_v1_CreateRoleRequest_Builder_setRoleId_java_lang_String_) ( roleId ) 
. setRole ( roleBuilder ) 
. build (); 
...
// once, and can be reused for multiple requests. 
try ( [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) iamClient = [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) . create ()) { 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) result = iamClient . createRole ( createRoleRequest ); 
System . out . println ( "Created role: " + result . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html#com_google_iam_admin_v1_Role_getName__) ()); 
} 
} 
} 
```
...
from google.cloud.iam_admin_v1 import [ CreateRoleRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.CreateRoleRequest.html) , [ IAMClient ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html) , [ Role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.html)
...
try : 
role = client . [ create_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_create_role) ( request ) 
...
In the Cloud de Confiance console, go to the **Custom** tab of the **Roles**
page.

[
Go to the Roles page](https://console.cloud.s3nscloud.fr/iam-admin/roles/custom)
...
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) ; 
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html).[RoleLaunchStage](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.RoleLaunchStage.html) ; 
import com.google.iam.admin.v1.[UpdateRoleRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UpdateRoleRequest.html) ; 
...
// See launch stage enums at 
// https://cloud.google.com/iam/docs/reference/rpc/google.iam.admin.v1#rolelaunchstage 
. setStage ( [ RoleLaunchStage ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.RoleLaunchStage.html) . GA ); 
[ FieldMask ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) fieldMask = [ FieldMask ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.html) . newBuilder (). [ addPaths ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.Builder.html#com_google_protobuf_FieldMask_Builder_addPaths_java_lang_String_) ( "description" ). [ addPaths ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.FieldMask.Builder.html#com_google_protobuf_FieldMask_Builder_addPaths_java_lang_String_) ( "stage" ). build (); 
[ UpdateRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UpdateRoleRequest.html) updateRoleRequest = 
[ UpdateRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UpdateRoleRequest.html) . newBuilder () 
. setName ( roleName ) 
. setRole ( roleBuilder ) 
...
// once, and can be reused for multiple requests. 
try ( [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) iamClient = [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) . create ()) { 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) result = iamClient . updateRole ( updateRoleRequest ); 
...
```
from google.api_core.exceptions import NotFound 
from google.cloud.iam_admin_v1 import [ IAMClient ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html) , [ Role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.html) , [ UpdateRoleRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.UpdateRoleRequest.html)
...
try : 
role = client . [ update_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_update_role) ( request ) 
...
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) role = disableRole ( projectId , roleId ); 
System . out . println ( "Role name: " + role . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html#com_google_iam_admin_v1_Role_getName__) ()); 
System . out . println ( "Role stage: " + role . [ getStage ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html#com_google_iam_admin_v1_Role_getStage__) ()); 
} 

public static [ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) disableRole ( String projectId , String roleId ) 
throws IOException { 
String roleName = "projects/" + projectId + "/roles/" + roleId ; 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) role = [ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) . newBuilder () 
. setName ( roleName ) 
. setStage ( [ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) . RoleLaunchStage . DISABLED ) 
. build (); 
...
try : 
role = client . [ get_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_get_role) ( get_request ) 
role . stage = [ Role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.html) . [ RoleLaunchStage ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.RoleLaunchStage.html) . DISABLED 
update_request = UpdateRoleRequest ( name = role . name , role = role ) 
client . [ update_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_update_role) ( update_request ) 
...
In the Cloud de Confiance console, go to the **Custom** tab of the **Roles** page.
...
```
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) ; 
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html).[ListRolesPagedResponse](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.ListRolesPagedResponse.html) ; 
import com.google.iam.admin.v1.[ListRolesRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.ListRolesRequest.html) ; 
import java.io.IOException ; 
...
[ ListRolesRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.ListRolesRequest.html) listRolesRequest = 
[ ListRolesRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.ListRolesRequest.html) . newBuilder (). setParent ( "projects/" + projectId ). build (); 

// Initialize client for sending requests. This client only needs to be created 
// once, and can be reused for multiple requests. 
try ( [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) iamClient = [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) . create ()) { 
[ ListRolesPagedResponse ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.ListRolesPagedResponse.html) listRolesResponse = iamClient . listRoles ( listRolesRequest ); 
...
```
from google.cloud.iam_admin_v1 import [ IAMClient ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html) , [ ListRolesRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.ListRolesRequest.html) , [ RoleView ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.RoleView.html)
from google.cloud.iam_admin_v1.services.iam.pagers import [ ListRolesPager ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.pagers.ListRolesPager.html)

def list_roles ( 
project_id : str , show_deleted : bool = True , role_view : RoleView = [ RoleView ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.RoleView.html) . BASIC 
) - > ListRolesPager : 
...
roles = client . [ list_roles ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_list_roles) ( request ) 
...
```
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) ; 
import com.google.iam.admin.v1.[DeleteRoleRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.DeleteRoleRequest.html) ; 
import java.io.IOException ; 
...
String roleName = "projects/" + projectId + "/roles/" + roleId ; 
[ DeleteRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.DeleteRoleRequest.html) deleteRoleRequest = [ DeleteRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.DeleteRoleRequest.html) . newBuilder (). setName ( roleName ). build (); 
...
[ DeleteRoleRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.DeleteRoleRequest.html) , 
[ IAMClient ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html) , 
[ Role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.Role.html) , 
[ UndeleteRoleRequest ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.types.UndeleteRoleRequest.html) , 
) 
...
try : 
role = client . [ delete_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_delete_role) ( request ) 
...
period, the Cloud de Confiance console shows that the role was deleted. You can also
...
After the role is scheduled for permanent deletion, Cloud de Confiance initiates
...
7 days, Cloud de Confiance initiates the process to
...
import com.google.cloud.iam.admin.v1.[IAMClient](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) ; 
import com.google.iam.admin.v1.[Role](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) ; 
import com.google.iam.admin.v1.[UndeleteRoleRequest](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UndeleteRoleRequest.html) ; 
import java.io.IOException ; 
...
String roleName = "projects/" + projectId + "/roles/" + roleId ; 
[ UndeleteRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UndeleteRoleRequest.html) undeleteRoleRequest = 
[ UndeleteRoleRequest ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.UndeleteRoleRequest.html) . newBuilder (). setName ( roleName ). build (); 

// Initialize client for sending requests. This client only needs to be created 
// once, and can be reused for multiple requests. 
try ( [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) iamClient = [ IAMClient ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.cloud.iam.admin.v1.IAMClient.html) . create ()) { 
[ Role ](https://documentation.s3ns.fr/java/docs/reference/google-iam-admin/latest/com.google.iam.admin.v1.Role.html) result = iamClient . undeleteRole ( undeleteRoleRequest ); 
...
try : 
role = client . [ undelete_role ](https://documentation.s3ns.fr/python/docs/reference/iam/latest/google.cloud.iam_admin_v1.services.iam.IAMClient.html#google_cloud_iam_admin_v1_services_iam_IAMClient_undelete_role) ( request ) 
