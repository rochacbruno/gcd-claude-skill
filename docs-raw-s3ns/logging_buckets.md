...
- Configure your Cloud de Confiance project:
...
To create a user-defined log bucket for your Cloud de Confiance project, do the
following:
...
To create a log bucket in your Cloud de Confiance project, do the following:

- 

In the Cloud de Confiance console, go to the Logs Storage** page:
...
To list the log buckets associated with a Cloud de Confiance project, and to see
...
To list the log buckets associated with a Cloud de Confiance project, use
...
or the Cloud de Confiance console.
...
[ Cloud de Confiance console ](#cloud-de-confiance-console) [ gcloud ](#gcloud) 
More 
...
The Cloud de Confiance console doesn't support locking a log bucket.
...
[Go to **IAM**](https://console.cloud.s3nscloud.fr/iam-admin/iam)
...
is a service account, its ID contains the string `s3ns-system.iam.gserviceaccount.com`.

- 

Optional: If you want to remove a service account from being able to route
logs to your Cloud de Confiance project, select the
...
[centralized Cloud de Confiance project](/logging/docs/central-log-storage), which
...
Cloud de Confiance project level.
...
Cloud de Confiance project. You shouldn't see the excluded logs anymore.
