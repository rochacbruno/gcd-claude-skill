...
Source: https://documentation.s3ns.fr/docs/authentication/get-id-token
...
Cloud de Confiance, you can probably use these methods. However, you should
...
on the following Cloud de Confiance services:
...
```
import com.google.auth.oauth2.[GoogleCredentials](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.GoogleCredentials.html) ; 
import com.google.auth.oauth2.[IdTokenCredentials](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.html) ; 
import com.google.auth.oauth2.[IdTokenProvider](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.html) ; 
import com.google.auth.oauth2.[IdTokenProvider](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.html).[Option](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.Option.html) ; 
...
// working environment. 
[ GoogleCredentials ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.GoogleCredentials.html) googleCredentials = [ GoogleCredentials ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.GoogleCredentials.html) . [ getApplicationDefault ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.GoogleCredentials.html#com_google_auth_oauth2_GoogleCredentials_getApplicationDefault__) (); 

[ IdTokenCredentials ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.html) idTokenCredentials = 
[ IdTokenCredentials ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.html) . newBuilder () 
. [ setIdTokenProvider ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.Builder.html#com_google_auth_oauth2_IdTokenCredentials_Builder_setIdTokenProvider_com_google_auth_oauth2_IdTokenProvider_) (( [ IdTokenProvider ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.html) ) googleCredentials ) 
. [ setTargetAudience ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.Builder.html#com_google_auth_oauth2_IdTokenCredentials_Builder_setTargetAudience_java_lang_String_) ( url ) 
// Setting the ID token options. 
. [ setOptions ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.Builder.html#com_google_auth_oauth2_IdTokenCredentials_Builder_setOptions_java_util_List_com_google_auth_oauth2_IdTokenProvider_Option__) ( Arrays . asList ( [ Option ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.Option.html) . FORMAT_FULL , [ Option ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenProvider.Option.html) . LICENSES_TRUE )) 
. build (); 

// Get the ID token. 
// Once you've obtained the ID token, you can use it to make an authenticated call to the 
// target audience. 
String idToken = idTokenCredentials . [ refreshAccessToken ](https://documentation.s3ns.fr/java/docs/reference/google-auth-library/latest/com.google.auth.oauth2.IdTokenCredentials.html#com_google_auth_oauth2_IdTokenCredentials_refreshAccessToken__) (). getTokenValue (); 
...
const { GoogleAuth } = require ( '[google-auth-library](https://documentation.s3ns.fr/nodejs/docs/reference/google-auth-library/latest/overview.html)' ); 

async function getIdTokenFromMetadataServer () { 
const googleAuth = new [ GoogleAuth ](https://documentation.s3ns.fr/nodejs/docs/reference/google-auth-library/latest/google-auth-library/googleauth.html) (); 

const client = await googleAuth . [ getIdTokenClient ](https://documentation.s3ns.fr/nodejs/docs/reference/google-auth-library/latest/google-auth-library/googleauth.html) ( targetAudience ); 

// Get the ID token. 
// Once you've obtained the ID token, you can use it to make an authenticated call 
// to the target audience. 
await client . [ idTokenProvider ](https://documentation.s3ns.fr/nodejs/docs/reference/google-auth-library/latest/google-auth-library/idtokenclient.html) . fetchIdToken ( targetAudience ); 
...
```
import [ google ](https://documentation.s3ns.fr/python/docs/reference/googleapis-common-protos/latest)
...
request = [ google ](https://documentation.s3ns.fr/python/docs/reference/googleapis-common-protos/latest) . auth . transport . [ requests ](https://documentation.s3ns.fr/python/docs/reference/google-resumable-media/latest/google.resumable_media.requests.html) . [ Request ](https://documentation.s3ns.fr/python/docs/reference/policytroubleshooter-iam/latest/google.cloud.policytroubleshooter_iam_v3.types.ConditionContext.Request.html) () 
...
id_client = Google :: Auth :: [ GCECredentials ](https://documentation.s3ns.fr/ruby/docs/reference/googleauth/latest/Google-Auth-GCECredentials.html) . new target_audience : url 

# Get the ID token. 
# Once you've obtained the ID token, you can use it to make an authenticated call 
# to the target audience. 
id_client . [ fetch_access_token ](https://documentation.s3ns.fr/ruby/docs/reference/googleauth/latest/Google-Auth-GCECredentials.html)
...
Some Cloud de Confiance services help you call other services. These connecting
