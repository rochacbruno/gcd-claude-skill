...
Source: https://documentation.s3ns.fr/iam/docs/attach-service-accounts
...
For some Cloud de Confiance resources, you can specify a user-managed service account that the
...
When code running on the resource accesses Cloud de Confiance services and resources, it uses the
service account attached to the resource as its identity. For example, if you [attach a
service account to a Compute Engine instance](/compute/docs/access/service-accounts#associating_a_service_account_to_an_instance), and the applications on the instance use a [client library](/apis/docs/client-libraries-explained) to call Cloud de Confiance APIs,
...
[Enable the APIs](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=iam.googleapis.com,cloudresourcemanager.googleapis.com&redirect=https%3A//console.cloud.google.com)
...
[Go to Service
accounts](https://console.cloud.s3nscloud.fr/projectselector/iam-admin/serviceaccounts)
...
```
POST https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ USER_SA_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:getIamPolicy
```
...
-d @request.json \
"https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ USER_SA_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:getIamPolicy"
```
...
-InFile request.json `
-Uri "https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ USER_SA_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:getIamPolicy" | Select-Object -Expand Content
```
...
"role" : "roles/iam.serviceAccountUser" , 
"members" : [ 
"serviceAccount: SERVICE_ACCOUNT_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com" 
] 
} 
] 
} 
...
```
POST https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ SERVICE_ACCOUNT_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:setIamPolicy
```
...
-H "Content-Type: application/json; charset=utf-8" \
-d @request.json \
"https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ SERVICE_ACCOUNT_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:setIamPolicy"
```
...
-ContentType: "application/json; charset=utf-8" `
-InFile request.json `
-Uri "https://iam.googleapis.com/v1/projects/ PROJECT_ID /serviceAccounts/ SERVICE_ACCOUNT_NAME @ PROJECT_ID .s3ns.iam.gserviceaccount.com:setIamPolicy" | Select-Object -Expand Content
```
...
across projects, then monitoring your Cloud de Confiance environment for issues.
If you see any issues, you can [re-enable the service accounts](/iam/docs/service-accounts-disable-enable#enabling). If
you don't see any issues, then you might not have any Cloud de Confiance
