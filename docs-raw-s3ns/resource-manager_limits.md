...
Source: https://documentation.s3ns.fr/resource-manager/docs/limits
...
on the [New Project](https://console.cloud.s3nscloud.fr/projectcreate) page. For more information, see
[Managing project quotas](https://documentation.s3ns.fr/resource-manager/docs/creating-managing-projects#managing_project_quotas).
...
API library](https://console.cloud.s3nscloud.fr/apis/enabled) in the Cloud de Confiance console, and select an API from the
list.
