...
Source: https://documentation.s3ns.fr/pubsub/docs/troubleshooting
...
[Go to Logs Explorer](https://console.cloud.s3nscloud.fr/logs) 

- 

Select an existing Cloud de Confiance project, folder, or organization.
...
In the Cloud de Confiance console, go to the Pub/Sub subscriptions
...
[Permissions page](https://console.cloud.s3nscloud.fr/iam-admin/iam) to see if an
...
@appspot.s3ns-system.iam.gserviceaccount.com`.
...
Pub/Sub client applications attempt to connect to Cloud de Confiance by S3NS
...
```
import com.google.api.gax.rpc.[NotFoundException](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.NotFoundException.html) ; 
import com.google.cloud.pubsub.v1.[AckReplyConsumer](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.AckReplyConsumer.html) ; 
import com.google.cloud.pubsub.v1.[MessageReceiver](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.MessageReceiver.html) ; 
import com.google.cloud.pubsub.v1.[Subscriber](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html) ; 
...
import com.google.pubsub.v1.[PushConfig](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PushConfig.html) ; 
import com.google.pubsub.v1.[Subscription](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Subscription.html) ; 
...
[ MessageReceiver ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.MessageReceiver.html) receiver = 
...
[ Subscriber ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html) subscriber = null ; 
try { 
subscriber = [ Subscriber ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html) . newBuilder ( subscriptionName , receiver ). build (); 
...
new [ Subscriber ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html) . Listener () { 
public void failed ( [ Subscriber ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html) . State from , Throwable failure ) { 
System . out . println ( failure . getStackTrace ()); 
if ( failure instanceof [ NotFoundException ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.NotFoundException.html) ) { 
try ( [ SubscriptionAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) subscriptionAdminClient = 
[ SubscriptionAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) . create ()) { 
...
[ Subscription ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Subscription.html) subscription = 
subscriptionAdminClient . createSubscription ( 
subscriptionName , topicName , [ PushConfig ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PushConfig.html) . getDefaultInstance (), 10 ); 
System . out . println ( "Created pull subscription: " + subscription . [ getName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.Subscription.html#com_google_pubsub_v1_Subscription_getName__) ()); 
optimisticSubscribeExample ( projectId , subscriptionId , topicId ); 
...
subscriber . [ startAsync ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Subscriber.html#com_google_cloud_pubsub_v1_Subscriber_startAsync__) (). awaitRunning (); 
System . out . printf ( "Listening for messages on %s:\n" , subscriptionName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html#com_google_pubsub_v1_ProjectSubscriptionName_toString__) ()); 
subscriber . awaitTerminated ( 30 , TimeUnit . SECONDS ); 
} catch ( IllegalStateException e ) { 
// Prevent an exception from being thrown if it is the expected NotFoundException 
if ( ! ( subscriber . failureCause () instanceof [ NotFoundException ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.NotFoundException.html) )) { 
throw e ; 
} 
...
subscriber = pubsub_v1 . [ SubscriberClient ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.subscriber_client.SubscriberClient.html) () 
...
def callback ( message : pubsub_v1 . subscriber . message . [ Message ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.message.Message.html) ) - > None : 
# Ack message after processing it. 
message . [ ack ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.message.Message.html#google_cloud_pubsub_v1_subscriber_message_Message_ack) () 

# Wrap subscriber in a 'with' block to automatically call close() when done. 
with subscriber : 
try : 
# Optimistically subscribe to messages on the subscription. 
streaming_pull_future = [ subscribe ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.subscriber_client.SubscriberClient.html)r . [ subscribe ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.subscriber_client.SubscriberClient.html) ( 
