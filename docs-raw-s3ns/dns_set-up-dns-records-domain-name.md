...
Source: https://documentation.s3ns.fr/dns/docs/set-up-dns-records-domain-name
...
](https://documentation.s3ns.fr/dns/docs/set-up-dns-records-domain-name)
...
Enable the DNS API, if it is not already enabled.
...
[Enable the API](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=dns)
...
In the Cloud de Confiance console, go to the **Create a DNS zone** page.

[Go to Create a DNS zone](https://console.cloud.s3nscloud.fr/net-services/dns/zones/new/create)
...
In the Cloud de Confiance console, go to the **Cloud DNS** page.

[Go to Cloud DNS](https://console.cloud.s3nscloud.fr/net-services/dns/zones)
...
In the Cloud de Confiance console, go to the **Cloud DNS zones** page.

[Go to Cloud DNS zones](https://console.cloud.s3nscloud.fr/net-services/dns/zones)
...
- To determine costs, see [Cloud DNS Pricing](https://documentation.s3ns.fr/dns/pricing).