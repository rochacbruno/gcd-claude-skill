...
Source: https://documentation.s3ns.fr/docs/terraform/resource-management/managing-infrastructure-as-code
...
[Terraform](https://documentation.s3ns.fr/docs/terraform) 
and
[Cloud Build](/build) 
...
[Cloud Build](/build) 
(a Cloud de Confiance by S3NS continuous integration service) to automatically
...
are familiar with Cloud de Confiance, Linux, and GitHub.

The [State of DevOps](https://documentation.s3ns.fr/devops/)
...
`prod`, respectively—into a Cloud de Confiance project.
...
few files to point to your new bucket and your Cloud de Confiance project.
...
to run Terraform scripts with the goal of managing Cloud de Confiance resources,
...
Cloud de Confiance project so that Cloud Build can automatically apply
...
your workflow. You are redirected to Cloud de Confiance by S3NS to continue the
installation.

- 

Sign in with your Cloud de Confiance by S3NS account. If requested, authorize
...
repository is linked to your Cloud de Confiance project. From now on, changes to
...
your Cloud de Confiance project.
...
[Go to the Cloud Build page](https://console.cloud.s3nscloud.fr/cloud-build/builds) 
...
In the Cloud de Confiance console, open the **Build History** page to see
...
Cloud de Confiance so you won't be billed for them in the future.
...
- Watch
[Repeatable Cloud de Confiance Environments at Scale With Cloud Build Infra-As-Code Pipelines](https://www.youtube.com/watch?v=3vfXQxWJazM) 
...
- Check out the blog on [Ensuring scale and compliance of your Terraform Deployment with Cloud Build](https://documentation.s3ns.fr/blog/products/devops-sre/terraform-gitops-with-google-cloud-build-and-storage).

- Read our resources about
[DevOps](https://documentation.s3ns.fr/devops/).
