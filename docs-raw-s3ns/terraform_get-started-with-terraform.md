...
Source: https://documentation.s3ns.fr/docs/terraform/get-started-with-terraform
...
Cloud de Confiance* (*Cloud de Confiance provider*) lets you provision and
...
Review the `main.tf` file. This file defines the Cloud de Confiance
...
Terraform calls Cloud de Confiance APIs to create the VM instance defined in
the `main.tf` file.
