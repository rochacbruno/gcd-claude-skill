...
Source: https://documentation.s3ns.fr/docs/quotas/terraform-support-for-cloud-quotas
...
to provision infrastructure on Cloud de Confiance by S3NS, refer to the
[Terraform on Cloud de Confiance by S3NS documentation](/docs/terraform).
...
- [google_cloud_quotas_quota_adjuster_settings](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/cloud_quotas_quota_adjuster_settings) ([Preview](https://documentation.s3ns.fr/products#product-launch-stages))
