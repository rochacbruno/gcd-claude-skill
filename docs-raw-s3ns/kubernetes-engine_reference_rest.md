...
](https://documentation.s3ns.fr/kubernetes-engine/docs/authentication)
...
- [https://container.s3nsapis.fr/$discovery/rest?version=v1](https://container.s3nsapis.fr/$discovery/rest?version=v1)

- [https://container.s3nsapis.fr/$discovery/rest?version=v1beta1](https://container.s3nsapis.fr/$discovery/rest?version=v1beta1)
...
Zonal clusters are not supported.
Returns configuration info about the Cloud de Confiance Kubernetes Engine service. | 
|
...
Zonal clusters are not supported.
Fetches locations that offer Cloud de Confiance Kubernetes Engine. | 
|
...
Zonal clusters are not supported.
Creates a cluster, consisting of the specified number and type of Cloud de Confiance Compute Engine instances. | 
|
...
The method `google.container.v1beta1.ClusterManager.CompleteControlPlaneUpgrade` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.container.v1.ClusterManager.FetchNodePoolUpgradeInfo` is not available in Cloud de Confiance by S3NS. | 
|
