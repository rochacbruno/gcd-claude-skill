...
the Cloud de Confiance console in Logs Explorer:
...
the 2SV requirement at the organization level in the Cloud de Confiance console.
...
out of the requirement at the organization level in the Cloud de Confiance console.
