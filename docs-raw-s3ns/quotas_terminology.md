...
Source: https://documentation.s3ns.fr/docs/quotas/terminology
...
Quotas and system limits restrict your use of Cloud de Confiance by S3NS resources to
support resource availability for all Cloud de Confiance by S3NS users. Quotas have default
...
Usually, *quota* refers to a Cloud de Confiance by S3NS resource and its
...
Cloud de Confiance by S3NS documentation uses the word *quota* in its more
...
requests are subject to review by Cloud de Confiance by S3NS.
...
Quota adjuster settings ([Preview](https://documentation.s3ns.fr/products#product-launch-stages))
| 
...
Cloud Quotas obtains information from the quotas defined by Cloud de Confiance services and any fulfilled quota adjustments that you initiate.
...
Cloud de Confiance by S3NS console, the Cloud Quotas API, or the
Google Cloud CLI.
| 
|
