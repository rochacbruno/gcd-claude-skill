...
- Manually by using the Cloud de Confiance console or the bq command-line tool
...
- Enter the schema using the Cloud de Confiance console.
...
[ Console ](#console) [ SQL ](#sql) [ bq ](#bq) [Terraform](#terraform) [ API ](#api) [ C# ](#c) [ Go ](#go) [ Java ](#java) [ Node.js ](#node.js) 
More 
...
[Activate Cloud Shell](https://console.cloud.s3nscloud.fr/?cloudshell=true)



At the bottom of the Cloud de Confiance console, a
...
table. You must
[enable the Cloud Key Management Service API](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=cloudkms.googleapis.com&redirect=https://console.cloud.s3nscloud.fr/) before running this example.
...
To apply your Terraform configuration in a Cloud de Confiance project, complete the steps in the
following sections.
...
Set the default Cloud de Confiance project
...
- [Open your Cloud de Confiance project](https://console.cloud.s3nscloud.fr/) to view
the results. In the Cloud de Confiance console, navigate to your resources in the UI to make sure
...
sampleSchema := bigquery . [ Schema ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Schema) { 
{ Name : "full_name" , Type : bigquery . [ StringFieldType ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_StringFieldType_BytesFieldType_IntegerFieldType_FloatFieldType_BooleanFieldType_TimestampFieldType_RecordFieldType_DateFieldType_TimeFieldType_DateTimeFieldType_NumericFieldType_GeographyFieldType_BigNumericFieldType_IntervalFieldType_JSONFieldType_RangeFieldType) }, 
{ Name : "age" , Type : bigquery . [ IntegerFieldType ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_StringFieldType_BytesFieldType_IntegerFieldType_FloatFieldType_BooleanFieldType_TimestampFieldType_RecordFieldType_DateFieldType_TimeFieldType_DateTimeFieldType_NumericFieldType_GeographyFieldType_BigNumericFieldType_IntervalFieldType_JSONFieldType_RangeFieldType) }, 
} 

metaData := & bigquery . [ TableMetadata ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_TableMetadata) { 
Schema : sampleSchema , 
...
import com.google.cloud.bigquery.[StandardTableDefinition](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardTableDefinition.html) ; 
import com.google.cloud.bigquery.[TableDefinition](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableDefinition.html) ; 
...
import com.google.cloud.bigquery.[TableInfo](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html) ; 
...
[ Field ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Field.html) . of ( "stringField" , [ StandardSQLTypeName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardSQLTypeName.html) . STRING ), 
[ Field ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Field.html) . of ( "booleanField" , [ StandardSQLTypeName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardSQLTypeName.html) . BOOL )); 
createTable ( datasetName , tableName , schema ); 
} 

public static void createTable ( String datasetName , String tableName , [ Schema ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Schema.html) schema ) { 
try { 
...
[ TableDefinition ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableDefinition.html) tableDefinition = [ StandardTableDefinition ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardTableDefinition.html) . of ( schema ); 
[ TableInfo ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html) tableInfo = [ TableInfo ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html) . newBuilder ( tableId , tableDefinition ). build (); 

bigquery . [ create ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_create_com_google_cloud_bigquery_DatasetInfo_com_google_cloud_bigquery_BigQuery_DatasetOption____) ( tableInfo ); 
...
. dataset ( datasetId ) 
. [ createTable ](https://documentation.s3ns.fr/nodejs/docs/reference/bigquery/latest/bigquery/dataset.html) ( tableId , options ); 
...
schema = [ 
[ bigquery ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest) . [ SchemaField ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.schema.SchemaField.html) ( "full_name" , "STRING" , mode = "REQUIRED" ), 
[ bigquery ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest) . [ SchemaField ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.schema.SchemaField.html) ( "age" , "INTEGER" , mode = "REQUIRED" ), 
] 

table = [ bigquery ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest) . [ Table ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.table.Table.html) ( table_id , schema = schema ) 
table = client . [ create_table ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html#google_cloud_bigquery_client_Client_create_table) ( table ) # Make an API request. 
print ( 
...
try { 
// Initialize client that will be used to send requests. This client only needs to be created 
// once, and can be reused for multi[ple requ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html)ests. 
[ BigQuery bigque ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryOptions.html)ry = BigQueryOptions . getDefaultInstance (). g[etServi](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html)ce (); 

[ ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) [ Table ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html)Id tableId = TableId . of ( datasetName [ , tableName ); 
](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableDefinition.html) TableDefinitio[n](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardTableDefinition.html) [ tableDefinition = Sta ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.StandardTableDefinition.html)ndar[dTable](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.Schema.html)Definition . of ( [ Schema . of ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html) ()); 
Ta[bleInfo](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html) [ t ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableInfo.html)ableInfo = TableInfo . newBuilder ( tableId , tableDefinition ). build [ (); 

](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_create_com_google_cloud_bigquery_DatasetInfo_com_google_cloud_bigquery_BigQuery_DatasetOption____) bigquery . create ( tableInfo ); 
System . out . println ( "Table created succ[essfully"](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryException.html) [ ); 
](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryException.html) } catch ( BigQueryException e ) { 
...
[Go to the BigQuery page](https://console.cloud.s3nscloud.fr/bigquery) 
...
retrieves data from the [USA Name Data public dataset](https://console.cloud.s3nscloud.fr/marketplace/product/social-security-administration/us-names).
...
q . [ Location ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Job_Location) = "US" // Location must match the dataset(s) referenced in query. 
q . [ QueryConfig ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_QueryConfig) . Dst = client . Dataset ( destDatasetID ). Table ( destTableID ) 
...
it , err := job . Read ( ctx ) 
for { 
var row [] bigquery . [ Value ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Value)
err := it . Next ( & row ) 
...
table](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.QueryJobConfiguration.Builder#com_google_cloud_bigquery_QueryJobConfiguration_Builder_setDestinationTable_com_google_cloud_bigquery_TableId_)
to the desired
[TableId](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId)
in a
[QueryJobConfiguration](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.QueryJobConfiguration).
...
[ TableId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) destinationTable = [ TableId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) . of ( destinationDataset , destinationTableId ); 
...
[ QueryJobConfiguration ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.QueryJobConfiguration.html) . newBuilder ( query ). setDestinationTable ( destinationTable ). build (); 

// Execute the query. 
bigquery . [ query ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_query_com_google_cloud_bigquery_QueryJobConfiguration_com_google_cloud_bigquery_BigQuery_JobOption____) ( queryConfig ); 
...
console . log ( `Job ${ [ job ](https://documentation.s3ns.fr/nodejs/docs/reference/bigquery/latest/bigquery/bigquery.html) . id } started.` ); 
...
job_config = [ bigquery ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest) . [ QueryJobConfig ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.job.QueryJobConfig.html) ( destination = table_id ) 
...
query_job = client . [ query ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html) ( sql , job_config = job_config ) # Make an API request. 
[ query_job ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.dbapi.Cursor.html#google_cloud_bigquery_dbapi_Cursor_query_job) . result () # Wait for the job to complete. 
...
different Cloud de Confiance by S3NS database, in files in Cloud Storage, or in a
...
- A high level in the
[Cloud de Confiance by S3NS resource hierarchy](/resource-manager/docs/cloud-platform-resource-hierarchy)
...
Granting IAM roles at a higher level in the [Cloud de Confiance by S3NS
...
fmt . Fprintf ( w , "Schema has %d top-level fields\n" , len ( meta . [ Schema ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Schema) )) 
...
import com.google.cloud.bigquery.[BigQueryException](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryException.html) ; 
import com.google.cloud.bigquery.[BigQueryOptions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryOptions.html) ; 
import com.google.cloud.bigquery.[Table](https://documentation.s3ns.fr/java/docs/reference/google-cloud-biglake/latest/com.google.cloud.bigquery.biglake.v1.Table.html) ; 
import com.google.cloud.bigquery.[TableId](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) ; 
...
[ TableId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) tableId = [ TableId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.TableId.html) . of ( projectId , datasetName , tableName ); 
[ Table ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-biglake/latest/com.google.cloud.bigquery.biglake.v1.Table.html) table = bigquery . [ getTable ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_getTable_com_google_cloud_bigquery_TableId_com_google_cloud_bigquery_BigQuery_TableOption____) ( tableId ); 
...
table = client . [ get_table ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html#google_cloud_bigquery_client_Client_get_table) ( table_id ) # Make an API request. 
...
print ( "Table has {} rows" . format ( table . [ num_rows ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.table.Table.html#google_cloud_bigquery_table_Table_num_rows) )) 
```
...
[`census_bureau_usa`](https://console.cloud.s3nscloud.fr/bigquery?p=bigquery-public-data&d=census_bureau_usa&page=dataset)
...
`DATASTORE_BACKUP`, `DELTA_LAKE` ([preview](https://documentation.s3ns.fr/products/#product-launch-stages)),
...
include: `AVRO`, `CSV`,
`DELTA_LAKE` ([preview](https://documentation.s3ns.fr/products/#product-launch-stages))
...
The list of data policies that are attached to the column to control access and masking. This field is in ([Preview](https://documentation.s3ns.fr/products#product-launch-stages)).
| 
|
...
One of `ALWAYS` or `BY DEFAULT`, depending on the
generation mode of the identity column. If the column isn't an identity
column, then the value is `NULL`.
| 
|
...
The first value generated by the identity column, or `NULL`
if the column isn't an identity column.
| 
|
...
The minimum difference between successively generated IDs for the
identity column, or `NULL` if the column isn't an
identity column.
| 
|
...
The maximum value that can be generated for the identity column, or
`NULL` if the column isn't an identity column.
| 
|
...
The minimum value that can be generated for the identity column, or
`NULL` if the column isn't an identity column.
| 
|
...
If the column is an identity column, then this value is
`NEVER`; otherwise, the value is `NULL`.
| 
|
...
[`census_bureau_usa`](https://console.cloud.s3nscloud.fr/bigquery?p=bigquery-public-data&d=census_bureau_usa&page=dataset)
dataset. This dataset is part of the BigQuery
[public dataset program](https://documentation.s3ns.fr/public-datasets/).
...
[`github_repos` dataset](https://console.cloud.s3nscloud.fr/bigquery?p=bigquery-public-data&d=github_repos&page=dataset).
...
[Storage pricing](https://documentation.s3ns.fr/bigquery/pricing#storage) for pricing information.
...
is the default syntax in the Cloud de Confiance console.
...
In the Cloud de Confiance console, in the navigation pane, click your dataset
...
ts := client . Dataset ( datasetID ). [ Tables ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/bigquery/latest/index.html#cloud_google_com_go_bigquery_Dataset_Tables) ( ctx ) 
for { 
t , err := ts . Next () 
if err == iterator . Done { 
break 
...
```
import com.google.api.gax.paging.[Page](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.paging.Page.html) ; 
import com.google.cloud.bigquery.[BigQuery](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html) ; 
import com.google.cloud.bigquery.[BigQuery](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html).[TableListOption](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.TableListOption.html) ; 
import com.google.cloud.bigquery.[BigQueryException](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryException.html) ; 
import com.google.cloud.bigquery.[BigQueryOptions](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQueryOptions.html) ; 
import com.google.cloud.bigquery.[DatasetId](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.DatasetId.html) ; 
import com.google.cloud.bigquery.[Table](https://documentation.s3ns.fr/java/docs/reference/google-cloud-biglake/latest/com.google.cloud.bigquery.biglake.v1.Table.html) ; 
...
[ DatasetId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.DatasetId.html) datasetId = [ DatasetId ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.DatasetId.html) . of ( projectId , datasetName ); 
Page tables = bigquery . [ listTables ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigquery/latest/com.google.cloud.bigquery.BigQuery.html#com_google_cloud_bigquery_BigQuery_listTables_com_google_cloud_bigquery_DatasetId_com_google_cloud_bigquery_BigQuery_TableListOption____) ( datasetId , TableListOption . pageSize ( 100 )); 
...
const [ tables ] = await bigquery . dataset ( datasetId ). [ getTables ](https://documentation.s3ns.fr/nodejs/docs/reference/bigquery/latest/bigquery/dataset.html) (); 
...
tables = client . [ list_tables ](https://documentation.s3ns.fr/python/docs/reference/bigquery/latest/google.cloud.bigquery.client.Client.html#google_cloud_bigquery_client_Client_list_tables) ( dataset_id ) # Make an API request. 
...
You can access audit information from the Cloud de Confiance console, `gcloud` command
...
In the Cloud de Confiance console, go to the Logging** page.

[Go to Logging](https://console.cloud.s3nscloud.fr/logs)
...
- `logName = "projects/ PROJECT_ID /logs/cloudaudit.googleapis.com%2Factivity"`:
This line filters for Admin Activity audit logs within your Cloud de Confiance by S3NS
