...
[Enable the API](https://console.cloud.s3nscloud.fr/apis/enableflow?apiid=artifactregistry.googleapis.com&redirect=https%3A//cloud.google.com/artifact-registry/docs/docker/quickstart)
...
Where PROJECT is your Cloud de Confiance by S3NS project ID.
...
To set up authentication to Docker repositories in the region `u-france-east1`,
...
Artifact Registry in your Cloud de Confiance project to push and pull images.
...
location is `u-france-east1-docker.s3nsregistry.fr`.
...
- `u-france-east1` is the repository location.
...
- Read our resources about [DevOps](https://documentation.s3ns.fr/devops/) and explore the
