...
- [ Grant or revoke multiple IAM roles using the Cloud de Confiance console ](#multiple-roles-console)
...
Cloud de Confiance by S3NS resource. Each allow policy contains a collection of *role
...
Cloud de Confiance console, the Google Cloud CLI, the REST API, or the [Resource Manager
...
- 
To manage access to almost all Cloud de Confiance resources:
...
the Cloud de Confiance console, the gcloud CLI, the REST API, or the
...
[Go
to IAM](https://console.cloud.s3nscloud.fr/projectselector/iam-admin/iam?supportedpurview=project,folder,organizationId)

- 

Select a project, folder, or organization.

The Cloud de Confiance console lists all the principals who have been granted
...
the **Include S3NS-provided role grants** checkbox.
...
` RESOURCE_ID `: Your Cloud de Confiance project, folder,
...
. [ CreateScoped ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Apis/latest/Google.Apis.Auth.OAuth2.GoogleCredential.html#Google_Apis_Auth_OAuth2_GoogleCredential_CreateScoped_System_Collections_Generic_IEnumerable_System_String__) ( CloudResourceManagerService . Scope . CloudPlatform ); 
...
public static [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) getProjectPolicy ( String projectId ) throws IOException { 
...
- ` RESOURCE_ID `: Your Cloud de Confiance
...
You can use the Cloud de Confiance console and the gcloud CLI to quickly
...
S3NS-provided role grants** checkbox to see its email address.
...
[
Go to IAM](https://console.cloud.s3nscloud.fr/projectselector/iam-admin/iam?supportedpurview=project,folder,organizationId)
...
`example-service-account@example-project.s3ns.iam.gserviceaccount.com` for the project `example-project`:
...
Cloud de Confiance has identified as important.

## Grant or revoke multiple IAM roles using the Cloud de Confiance console

You can use the Cloud de Confiance console to grant and revoke multiple roles for
a single principal:
...
**Include S3NS-provided role grants** checkbox to see its
email address.
...
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy = [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) . newBuilder (). build (); 
...
public static [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) addMember ( [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy , String role , String member ) { 
...
newBindingsList . add ( b . toBuilder (). [ addMembers ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.Builder.html#com_google_iam_v1_Binding_Builder_addMembers_java_lang_String_) ( member ). build ()); 
} else { 
...
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) updatedPolicy = policy . [ toBuilder ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_toBuilder__) () 
. [ clearBindings ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.Builder.html#com_google_iam_v1_Policy_Builder_clearBindings__) () 
. [ addAllBindings ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.Builder.html#com_google_iam_v1_Policy_Builder_addAllBindings_java_lang_Iterable___extends_com_google_iam_v1_Binding__) ( newBindingsList ) 
. build (); 

System . out . println ( "Added principal: " + updatedPolicy . [ getBindingsList ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_getBindingsList__) ()); 
...
public static [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) addBinding ( [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy , String role , List members ) { 
[ Binding ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html) binding = [ Binding ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html) . newBuilder () 
. setRole ( role ) 
. [ addAllMembers ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.Builder.html#com_google_iam_v1_Binding_Builder_addAllMembers_java_lang_Iterable_java_lang_String__) ( members ) 
. build (); 

// Update bindings for the policy. 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) updatedPolicy = policy . [ toBuilder ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_toBuilder__) (). [ addBindings ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.Builder.html#com_google_iam_v1_Policy_Builder_addBindings_com_google_iam_v1_Binding_) ( binding ). build (); 

System . out . println ( "Added binding: " + updatedPolicy . [ getBindingsList ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_getBindingsList__) ()); 
...
public static [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) removeMember ( [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy , String role , String member ) { 
// Creating new builder with all values copied from origin policy 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) . Builder policyBuilder = policy . [ toBuilder ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_toBuilder__) (); 
...
[ Binding ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html) newBinding = binding . [ toBuilder ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html#com_google_iam_v1_Binding_toBuilder__) () 
. [ clearMembers ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.Builder.html#com_google_iam_v1_Binding_Builder_clearMembers__) () 
...
policyBuilder . [ clearBindings ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.Builder.html#com_google_iam_v1_Policy_Builder_clearBindings__) () 
...
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) updatedPolicy = policyBuilder . build (); 

System . out . println ( "Exising principals: " + updatedPolicy . [ getBindingsList ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html#com_google_iam_v1_Policy_getBindingsList__) ()); 
...
public static [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) setProjectPolicy ( [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy , String projectId ) 
throws IOException { 
...
request = iam_policy_pb2 . GetIamPolicyRequest () 
request . resource = f "projects/ { project_id } " 
current_policy = client . [ get_iam_policy ](https://documentation.s3ns.fr/python/docs/reference/cloudresourcemanager/latest/google.cloud.resourcemanager_v3.services.projects.ProjectsClient.html#google_cloud_resourcemanager_v3_services_projects_ProjectsClient_get_iam_policy) ( request ) 
...
policy = client . [ set_iam_policy ](https://documentation.s3ns.fr/python/docs/reference/cloudresourcemanager/latest/google.cloud.resourcemanager_v3.services.projects.ProjectsClient.html#google_cloud_resourcemanager_v3_services_projects_ProjectsClient_set_iam_policy) ( request ) 
return policy 
```
