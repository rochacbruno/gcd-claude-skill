...
usage in Cloud de Confiance by S3NS. Dimensions are typically a region, zone, Cloud de Confiance by S3NS
...
given family in your Cloud de Confiance by S3NS project.

## View dimensions

You can view the dimensions for quotas and system limits by looking in the
Cloud de Confiance console, using the Google Cloud CLI, querying the REST API, or through
...
` PROJECT_ID `: The ID of your Cloud de Confiance
