...
Source: https://documentation.s3ns.fr/kms/docs/reference/rest
...
](https://documentation.s3ns.fr/kms/docs/apis)
...
- [https://cloudkms.s3nsapis.fr/$discovery/rest?version=v1](https://cloudkms.s3nsapis.fr/$discovery/rest?version=v1)
...
The method `google. cloud. kms. v1. Autokey Admin. Get Autokey Config` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.KeyAccessJustificationsConfig.GetKeyAccessJustificationsPolicyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.AutokeyAdmin.UpdateAutokeyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.KeyAccessJustificationsConfig.UpdateKeyAccessJustificationsPolicyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.AutokeyAdmin.GetAutokeyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.AutokeyAdmin.ShowEffectiveAutokeyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.KeyAccessJustificationsConfig.ShowEffectiveKeyAccessJustificationsEnrollmentConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.KeyAccessJustificationsConfig.ShowEffectiveKeyAccessJustificationsPolicyConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.Autokey.CreateKeyHandle` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.Autokey.GetKeyHandle` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.Autokey.ListKeyHandles` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.kms.v1.KeyManagementService.Decapsulate` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.longrunning.Operations.GetOperation` is not available in Cloud de Confiance by S3NS. | 
|