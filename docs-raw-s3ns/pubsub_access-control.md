...
- [ Controlling access through the Cloud de Confiance console ](#console)
...
Cloud de Confiance console or the IAM API.
...
subscription, you cannot view the resource using the Cloud de Confiance console.
...
Similar to other Cloud de Confiance by S3NS products, Pub/Sub supports
...
Cloud de Confiance resources. For more information about
...
The following sections list Pub/Sub permissions required for
...
## Controlling access through the Cloud de Confiance console

You can use the Cloud de Confiance console to manage access control for your topics
and projects.
...
[Go
to IAM](https://console.cloud.s3nscloud.fr/project/_/iam-admin/iam)
...
In the Cloud de Confiance console, go to the Pub/Sub **Topics** list.

[Go
to Topics](https://console.cloud.s3nscloud.fr/cloudpubsub/topic/list)
...
manage policies at the Cloud de Confiance project level.
...
For more information, see the [Pub/Sub C# API reference documentation](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest).
...
"members" : [ 
"serviceAccount:service-account-2@appspot.s3ns-system.iam.gserviceaccount.com" , 
...
req := & iampb . [ GetIamPolicyRequest ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_GetIamPolicyRequest) { 
Resource : subscription , 
} 
policy , err := client . SubscriptionAdminClient . [ GetIamPolicy ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_GetIamPolicy) ( ctx , req ) 
if err != nil { 
...
[Quickstart: Using Client Libraries](/pubsub/docs/create-topic-client-libraries).
For more information, see the [Pub/Sub Java API reference documentation](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/overview).
...
```
import com.google.cloud.pubsub.v1.[SubscriptionAdminClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) ; 
...
import com.google.pubsub.v1.[ProjectSubscriptionName](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html) ; 
...
throws IOException { 
try ( [ SubscriptionAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) subscriptionAdminClient = [ SubscriptionAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) . create ()) { 
[ ProjectSubscriptionName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html) subscriptionName = 
[ ProjectSubscriptionName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html) . of ( projectId , subscriptionId ); 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) getIamPolicyRequest = 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) . newBuilder (). setResource ( subscriptionName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html#com_google_pubsub_v1_ProjectSubscriptionName_toString__) ()). build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy = subscriptionAdminClient . getIamPolicy ( getIamPolicyRequest ); 
...
const { PubSub } = require ( '[@google-cloud/pubsub](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/overview.html)' ); 

// Creates a client; cache this for further use 
const pubSubClient = new [ PubSub ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/pubsub.html) (); 
...
. iam . [ getPolicy ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/iam.html) (); 
...
[Quickstart: Using Client Libraries](/pubsub/docs/create-topic-client-libraries).
For more information, see the [Pub/Sub PHP API reference documentation](https://documentation.s3ns.fr/php/docs/reference/cloud-pubsub/latest).
...
client = pubsub_v1 . [ SubscriberClient ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.subscriber_client.SubscriberClient.html) () 
...
client . [ close ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.client.Client.html#google_cloud_pubsub_v1_subscriber_client_Client_close) () 
```
...
policy = pubsub . [ iam ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) . get_iam_policy \ 
...
{ 
[ PublisherServiceApiClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html) publisher = [ PublisherServiceApiClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html) . [ Create ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_Create) (); 
[ TopicName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html) topicName = [ TopicName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html) . [ FromProjectTopic ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html#Google_Cloud_PubSub_V1_TopicName_FromProjectTopic_System_String_System_String_) ( projectId , topicId ); 
[ Policy ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Policy.html) policy = publisher . [ IAMPolicyClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_IAMPolicyClient) . GetIamPolicy ( new [ GetIamPolicyRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.GetIamPolicyRequest.html)
{ 
...
policy , err := client . TopicAdminClient . [ GetIamPolicy ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_GetIamPolicy) ( ctx , req ) 
if err != nil { 
return fmt . Errorf ( "Policy: %w" , err ) 
} 
for _ , b := range policy . Bindings { 
...
```
import com.google.cloud.pubsub.v1.[TopicAdminClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.TopicAdminClient.html) ; 
import com.google.iam.v1.[GetIamPolicyRequest](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) ; 
import com.google.iam.v1.[Policy](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) ; 
import com.google.pubsub.v1.[TopicName](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html) ; 
import java.io.IOException ; 
...
try ( [ TopicAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.TopicAdminClient.html) topicAdminClient = [ TopicAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.TopicAdminClient.html) . create ()) { 
[ TopicName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html) topicName = [ TopicName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html) . of ( projectId , topicId ); 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) getIamPolicyRequest = 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) . newBuilder (). setResource ( topicName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html#com_google_pubsub_v1_TopicName_toString__) ()). build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) policy = topicAdminClient . getIamPolicy ( getIamPolicyRequest ); 
...
const [ policy ] = await pubSubClient . topic ( topicNameOrId ). iam . [ getPolicy ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/iam.html) (); 
...
client = pubsub_v1 . [ PublisherClient ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.publisher_client.PublisherClient.html) () 
...
policy = pubsub . [ iam ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) . get_iam_policy resource : pubsub . topic_path ( topic_id ) 
...
[ Policy ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Policy.html) policy = new [ Policy ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Policy.html)
{ 
Bindings = { 
new [ Binding ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Binding.html)
{ 
...
[ SetIamPolicyRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.SetIamPolicyRequest.html) request = new [ SetIamPolicyRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.SetIamPolicyRequest.html)
{ 
ResourceAsResourceName = [ SubscriptionName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.SubscriptionName.html) . [ FromProjectSubscription ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.SubscriptionName.html#Google_Cloud_PubSub_V1_SubscriptionName_FromProjectSubscription_System_String_System_String_) ( projectId , subscriptionId ), 
Policy = policy 
}; 
[ Policy ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Policy.html) response = publisher . [ IAMPolicyClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_IAMPolicyClient) . SetIamPolicy ( request ); 
return response ; 
} 
} 
```
...
b := & iampb . [ Binding ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_Binding) { 
Role : "roles/editor" , 
...
setRequest := & iampb . [ SetIamPolicyRequest ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_SetIamPolicyRequest) { 
Resource : subName , 
Policy : policy , 
} 
_ , err = client . SubscriptionAdminClient . [ SetIamPolicy ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_SetIamPolicy) ( ctx , setRequest ) 
if err != nil { 
...
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) getIamPolicyRequest = 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) . newBuilder (). setResource ( subscriptionName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html#com_google_pubsub_v1_ProjectSubscriptionName_toString__) ()). build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) oldPolicy = subscriptionAdminClient . getIamPolicy ( getIamPolicyRequest ); 

// Create new role -> members binding 
[ Binding ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html) binding = 
[ Binding ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.html) . newBuilder () 
. setRole ( "roles/pubsub.editor" ) 
. [ addMembers ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Binding.Builder.html#com_google_iam_v1_Binding_Builder_addMembers_java_lang_String_) ( "domain:google.com" ) 
. build (); 

// Add new binding to updated policy 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) updatedPolicy = [ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) . newBuilder ( oldPolicy ). [ addBindings ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.Builder.html#com_google_iam_v1_Policy_Builder_addBindings_com_google_iam_v1_Binding_) ( binding ). build (); 

[ SetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.html) setIamPolicyRequest = 
[ SetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.html) . newBuilder () 
. setResource ( subscriptionName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html#com_google_pubsub_v1_ProjectSubscriptionName_toString__) ()) 
. [ setPolicy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.Builder.html#com_google_iam_v1_SetIamPolicyRequest_Builder_setPolicy_com_google_iam_v1_Policy_) ( updatedPolicy ) 
. build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) newPolicy = subscriptionAdminClient . setIamPolicy ( setIamPolicyRequest ); 
...
. subscription ( subscriptionNameOrId ) 
. iam . [ setPolicy ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/iam.html) ( newPolicy ); 
...
bindings = Google :: Iam :: [ V1 ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub-v1/latest/Google-Cloud-PubSub-V1.html) :: Binding . [ new ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub.html) \ 
role : role , 
members : [ service_account_email ] 

pubsub . [ iam ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) . set_iam_policy resource : pubsub . subscription_path ( subscription_id ), 
policy : { 
bindings : [ bindings ] 
} 
```
...
[ SetIamPolicyRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.SetIamPolicyRequest.html) request = new [ SetIamPolicyRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.SetIamPolicyRequest.html)
{ 
ResourceAsResourceName = [ TopicName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html) . [ FromProjectTopic ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.TopicName.html#Google_Cloud_PubSub_V1_TopicName_FromProjectTopic_System_String_System_String_) ( projectId , topicId ), 
Policy = policy 
}; 
[ Policy ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.Policy.html) response = publisher . [ IAMPolicyClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_IAMPolicyClient) . SetIamPolicy ( request ); 
return response ; 
...
_ , err = client . TopicAdminClient . [ SetIamPolicy ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_SetIamPolicy) ( ctx , setRequest ) 
if err != nil { 
return fmt . Errorf ( "error calling SetIamPolicy: %w" , err ) 
} 
...
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) getIamPolicyRequest = 
[ GetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.GetIamPolicyRequest.html) . newBuilder (). setResource ( topicName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html#com_google_pubsub_v1_TopicName_toString__) ()). build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) oldPolicy = topicAdminClient . getIamPolicy ( getIamPolicyRequest ); 
...
[ SetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.html) setIamPolicyRequest = 
[ SetIamPolicyRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.html) . newBuilder () 
. setResource ( topicName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.TopicName.html#com_google_pubsub_v1_TopicName_toString__) ()) 
. [ setPolicy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.SetIamPolicyRequest.Builder.html#com_google_iam_v1_SetIamPolicyRequest_Builder_setPolicy_com_google_iam_v1_Policy_) ( updatedPolicy ) 
. build (); 
[ Policy ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.Policy.html) newPolicy = topicAdminClient . setIamPolicy ( setIamPolicyRequest ); 
...
pubsub . [ iam ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) . set_iam_policy resource : pubsub . topic_path ( topic_id ), 
policy : { 
bindings : [ bindings ] 
} 
```
...
{ 
[ TestIamPermissionsRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.TestIamPermissionsRequest.html) request = new [ TestIamPermissionsRequest ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.TestIamPermissionsRequest.html)
{ 
ResourceAsResourceName = [ SubscriptionName ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.SubscriptionName.html) . [ FromProjectSubscription ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.SubscriptionName.html#Google_Cloud_PubSub_V1_SubscriptionName_FromProjectSubscription_System_String_System_String_) ( projectId , subscriptionId ), 
Permissions = { "pubsub.subscriptions.get" , "pubsub.subscriptions.update" } 
}; 
[ PublisherServiceApiClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html) publisher = [ PublisherServiceApiClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html) . [ Create ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_Create) (); 
[ TestIamPermissionsResponse ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.Iam.V1/latest/Google.Cloud.Iam.V1.TestIamPermissionsResponse.html) response = publisher . [ IAMPolicyClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherServiceApiClient.html#Google_Cloud_PubSub_V1_PublisherServiceApiClient_IAMPolicyClient) . TestIamPermissions ( request ); 
return response ; 
} 
} 
```
...
req := & iampb . [ TestIamPermissionsRequest ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_TestIamPermissionsRequest) { 
...
resp , err := client . SubscriptionAdminClient . [ TestIamPermissions ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_TestIamPermissions) ( ctx , req ) 
if err != nil { 
...
```
import com.google.cloud.pubsub.v1.[SubscriptionAdminClient](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.SubscriptionAdminClient.html) ; 
import com.google.iam.v1.[TestIamPermissionsRequest](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) ; 
import com.google.iam.v1.[TestIamPermissionsResponse](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsResponse.html) ; 
import com.google.pubsub.v1.[ProjectSubscriptionName](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html) ; 
import java.io.IOException ; 
...
[ TestIamPermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) testIamPermissionsRequest = 
[ TestIamPermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) . newBuilder () 
. setResource ( subscriptionName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectSubscriptionName.html#com_google_pubsub_v1_ProjectSubscriptionName_toString__) ()) 
. addAllPermissions ( permissions ) 
. build (); 

[ TestIamPermissionsResponse ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsResponse.html) testedPermissionsResponse = 
...
. subscription ( subscriptionNameOrId ) 
. iam . [ testPermissions ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/iam.html) ( permissionsToTest ); 
...
pubsub = Google :: Cloud :: [ PubSub ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub.html) . [ new ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub.html)
subscription_admin = pubsub . [ subscription_admin ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html)
permissions = [ "pubsub.subscriptions.consume" , "pubsub.subscriptions.update" ] 

response = pubsub . [ iam ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) . test_iam_permissions \ 
resource : pubsub . subscription_path ( subscription_id ), 
...
resp , err := client . TopicAdminClient . [ TestIamPermissions ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/iam/latest/apiv1/iampb.html#cloud_google_com_go_iam_apiv1_iampb_UnimplementedIAMPolicyServer_TestIamPermissions) ( ctx , req ) 
if err != nil { 
return nil , fmt . Errorf ( "error calling TestIamPermissions: %w" , err ) 
} 
for _ , perm := range resp . Permissions { 
...
import com.google.iam.v1.[TestIamPermissionsRequest](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) ; 
import com.google.iam.v1.[TestIamPermissionsResponse](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsResponse.html) ; 
import com.google.pubsub.v1.[ProjectTopicName](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectTopicName.html) ; 
import java.io.IOException ; 
import java.util.LinkedList ; 
import java.util.List ; 
...
throws IOException { 
try ( [ TopicAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.TopicAdminClient.html) topicAdminClient = [ TopicAdminClient ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.TopicAdminClient.html) . create ()) { 
[ ProjectTopicName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectTopicName.html) topicName = [ ProjectTopicName ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectTopicName.html) . of ( projectId , topicId ); 
...
[ TestIamPermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) testIamPermissionsRequest = 
[ TestIamPermissionsRequest ](https://documentation.s3ns.fr/java/docs/reference/proto-google-iam-v1/latest/com.google.iam.v1.TestIamPermissionsRequest.html) . newBuilder () 
. setResource ( topicName . [ toString ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.ProjectTopicName.html#com_google_pubsub_v1_ProjectTopicName_toString__) ()) 
. addAllPermissions ( permissions ) 
. build (); 
...
`foobar@` project-a `.s3ns.iam.gserviceaccount.com` of project-a the publisher role on the topic
...
bindings:
- members:
- serviceAccount:foobar@ project-a .s3ns.iam.gserviceaccount.com
role: roles/pubsub.publisher
etag: BwWGrQYX6R4=
```
