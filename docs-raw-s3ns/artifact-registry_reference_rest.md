...
Source: https://documentation.s3ns.fr/artifact-registry/docs/reference/rest
...
](https://documentation.s3ns.fr/artifact-registry/docs/apis)
...
Store and manage build artifacts in a scalable and integrated service built on Cloud de Confiance infrastructure.
...
- [https://artifactregistry.s3nsapis.fr/$discovery/rest?version=v1](https://artifactregistry.s3nsapis.fr/$discovery/rest?version=v1)
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetProjectSettings` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UpdateProjectSettings` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.location.Locations.GetLocation` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetVPCSCConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.cloud.location.Locations.ListLocations` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UpdateVPCSCConfig` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ExportArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ImportAptArtifacts` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadAptArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.CreateAttachment` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.DeleteAttachment` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetAttachment` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ListAttachments` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.DownloadFile` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetFile` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadGenericArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadGoModule` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ImportGoogetArtifacts` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadGoogetArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadKfpArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetMavenArtifact` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ListMavenArtifacts` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetNpmPackage` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ListNpmPackages` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetPackage` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetTag` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.BatchDeleteVersions` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetVersion` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetPythonPackage` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ListPythonPackages` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.CreateRule` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.DeleteRule` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.GetRule` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ListRules` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UpdateRule` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.ImportYumArtifacts` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.devtools.artifactregistry.v1.ArtifactRegistry.UploadYumArtifact` is not available in Cloud de Confiance by S3NS. | 
|