...
You can publish messages with the Cloud de Confiance console, Google Cloud CLI, Pub/Sub API,
...
[Go to the Pub/Sub topics page](https://console.cloud.s3nscloud.fr/cloudpubsub/topic/list) 
...
[ PublisherClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html) publisher = await [ PublisherClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html) . [ CreateAsync ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html#Google_Cloud_PubSub_V1_PublisherClient_CreateAsync_Google_Cloud_PubSub_V1_TopicName_) ( topicName ); 
...
await publisher . [ ShutdownAsync ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html#Google_Cloud_PubSub_V1_PublisherClient_ShutdownAsync_System_Threading_CancellationToken_) ( TimeSpan . FromSeconds ( 15 )); 
...
```
import com.google.api.core.[ApiFuture](https://documentation.s3ns.fr/java/docs/reference/api-common/latest/com.google.api.core.ApiFuture.html) ; 
import com.google.api.core.[ApiFutureCallback](https://documentation.s3ns.fr/java/docs/reference/api-common/latest/com.google.api.core.ApiFutureCallback.html) ; 
import com.google.api.core.[ApiFutures](https://documentation.s3ns.fr/java/docs/reference/api-common/latest/com.google.api.core.ApiFutures.html) ; 
import com.google.api.gax.rpc.[ApiException](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html) ; 
import com.google.cloud.pubsub.v1.[Publisher](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html) ; 
...
import com.google.pubsub.v1.[PubsubMessage](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.html) ; 
...
[ Publisher ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html) publisher = null ; 

try { 
// Create a publisher instance with default settings bound to the topic 
publisher = [ Publisher ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html) . newBuilder ( topicName ). build (); 

List messages = Arrays . asList ( "first message" , "second message" ); 

for ( final String message : messages ) { 
[ ByteString ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html) data = [ ByteString ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html) . [ copyFromUtf8 ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html#com_google_protobuf_ByteString_copyFromUtf8_java_lang_String_) ( message ); 
[ PubsubMessage ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.html) pubsubMessage = [ PubsubMessage ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.html) . newBuilder (). [ setData ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.Builder.html#com_google_pubsub_v1_PubsubMessage_Builder_setData_com_google_protobuf_ByteString_) ( data ). build (); 

// Once published, returns a server-assigned message id (unique within the topic) 
ApiFuture future = [ publish ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_publish_com_google_pubsub_v1_PubsubMessage_)er . [ publish ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_publish_com_google_pubsub_v1_PubsubMessage_) ( pubsubMessage ); 

// Add an asynchronous callback to handle success / failure 
[ ApiFutures ](https://documentation.s3ns.fr/java/docs/reference/api-common/latest/com.google.api.core.ApiFutures.html) . [ addCallback ](https://documentation.s3ns.fr/java/docs/reference/api-common/latest/com.google.api.core.ApiFutures.html#com_google_api_core_ApiFutures__V_addCallback_com_google_api_core_ApiFuture_V__com_google_api_core_ApiFutureCallback___super_V__) ( 
future , 
new ApiFutureCallback () { 

@Override 
public void onFailure ( Throwable throwable ) { 
if ( throwable instanceof [ ApiException ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html) ) { 
[ ApiException ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html) apiException = (( [ ApiException ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html) ) throwable ); 
// details on the API exception 
System . out . println ( apiException . [ getStatusCode ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html#com_google_api_gax_rpc_ApiException_getStatusCode__) (). getCode ()); 
System . out . println ( apiException . [ isRetryable ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.ApiException.html#com_google_api_gax_rpc_ApiException_isRetryable__) ()); 
} 
...
publisher . [ shutdown ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_shutdown__) (); 
publisher . [ awaitTermination ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_awaitTermination_long_java_util_concurrent_TimeUnit_) ( 1 , TimeUnit . MINUTES ); 
} 
} 
} 
} 
...
const dataBuffer = Buffer . [ from ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/duration.html) ( data ); 

// Cache topic objects (publishers) and reuse them. 
const topic = pubSubClient . topic ( topicNameOrId ); 

try { 
const messageId = await topic . [ publishMessage ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/topic.html) ({ data : dataBuffer }); 
...
publisher = pubsub_v1 . [ PublisherClient ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.publisher_client.PublisherClient.html) () 
...
print ( publish_future . [ result ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.publisher.futures.Future.html#google_cloud_pubsub_v1_publisher_futures_Future_result) ( timeout = 60 )) 
except futures . TimeoutError : 
print ( f "Publishing { [ data ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.message.Message.html#google_cloud_pubsub_v1_subscriber_message_Message_data) } timed out." ) 
...
publish_future = [ publish ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.publisher_client.PublisherClient.html)er . [ publish ](https://documentation.s3ns.fr/python/docs/reference/pubsublite/latest/google.cloud.pubsublite.cloudpubsub.publisher_client.PublisherClient.html) ( topic_path , [ data ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.subscriber.message.Message.html#google_cloud_pubsub_v1_subscriber_message_Message_data) . encode ( "utf-8" )) 
# Non-blocking. Publish failures are handled in the callback function. 
publish_future . [ add_done_callback ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.publisher.futures.Future.html#google_cloud_pubsub_v1_publisher_futures_Future_add_done_callback) ( get_callback ( publish_future , data )) 
...
publisher = pubsub . [ publisher ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) topic_id 

begin 
publisher . [ publish_async ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Publisher.html) "This is a test message." do | result | 
...
In the Cloud de Confiance console, go to the **Topics** page.
...
```
using [ Google.Cloud.PubSub.V1 ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.html) ; 
using [ Google.Protobuf ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.html) ; 
using System ; 
using System.Threading.Tasks ; 
...
var pubsubMessage = new [ PubsubMessage ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PubsubMessage.html)
{ 
// The data is any arbitrary ByteString. Here, we're using text. 
Data = [ ByteString ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.ByteString.html) . [ CopyFromUtf8 ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Protobuf/latest/Google.Protobuf.ByteString.html#Google_Protobuf_ByteString_CopyFromUtf8_System_String_) ( messageText ), 
...
string message = await publisher . [ PublishAsync ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html#Google_Cloud_PubSub_V1_PublisherClient_PublishAsync_Google_Cloud_PubSub_V1_PubsubMessage_) ( pubsubMessage ); 
Console . WriteLine ( $"Published message {message}" ); 
// PublisherClient instance should be shutdown after use. 
// The TimeSpan specifies for how long to attempt to publish locally queued messages. 
await publisher . [ ShutdownAsync ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html#Google_Cloud_PubSub_V1_PublisherClient_ShutdownAsync_System_Threading_CancellationToken_) ( TimeSpan . FromSeconds ( 15 )); 
...
[ ByteString ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html) data = [ ByteString ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html) . [ copyFromUtf8 ](https://documentation.s3ns.fr/java/docs/reference/protobuf/latest/com.google.protobuf.ByteString.html#com_google_protobuf_ByteString_copyFromUtf8_java_lang_String_) ( message ); 
[ PubsubMessage ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.html) pubsubMessage = 
[ PubsubMessage ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.html) . newBuilder () 
. [ setData ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.pubsub.v1.PubsubMessage.Builder.html#com_google_pubsub_v1_PubsubMessage_Builder_setData_com_google_protobuf_ByteString_) ( data ) 
. putAllAttributes ( ImmutableMap . of ( "year" , "2020" , "author" , "unknown" )) 
. build (); 

// Once published, returns a server-assigned message id (unique within the topic) 
ApiFuture messageIdFuture = [ publish ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_publish_com_google_pubsub_v1_PubsubMessage_)er . [ publish ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html#com_google_cloud_pubsub_v1_Publisher_publish_com_google_pubsub_v1_PubsubMessage_) ( pubsubMessage ); 
...
const messageId = await topic . [ publishMessage ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/topic.html) ({ 
data : dataBuffer , 
...
# Add two attributes, origin and username, to the message 
publisher . [ publish_async ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Publisher.html) "This is a test message." , 
origin : "ruby-sample" , 
...
When you run your application within Cloud de Confiance, by default it
connects to the Pub/Sub endpoint in the same region.
Therefore, running your application in a single region within
Cloud de Confiance generally ensures you are interacting with a single
region.

When you run your publisher application outside of
Cloud de Confiance or in multiple regions, you can guarantee you are
...
You can publish messages with ordering keys using the Cloud de Confiance console,
...
[ PublisherClient ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClient.html) publisher = await new [ PublisherClientBuilder ](https://documentation.s3ns.fr/dotnet/docs/reference/Google.Cloud.PubSub.V1/latest/Google.Cloud.PubSub.V1.PublisherClientBuilder.html)
{ 
TopicName = topicName , 
...
[ Publisher ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html) publisher = 
[ Publisher ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-pubsub/latest/com.google.cloud.pubsub.v1.Publisher.html) . newBuilder ( topicName ) 
...
const messageId = await topic . [ publishMessage ](https://documentation.s3ns.fr/nodejs/docs/reference/pubsub/latest/pubsub/topic.html) ( message ); 
...
publisher_options = pubsub_v1 . types . [ PublisherOptions ](https://documentation.s3ns.fr/python/docs/reference/pubsub/latest/google.cloud.pubsub_v1.types.PublisherOptions.html) ( enable_message_ordering = True ) 
# Sending messages to the same region ensures they are received in order 
# even when multiple publishers are used. 
...
publisher = pubsub . [ publisher ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Project.html) topic_id , async : { 
max_bytes : 1_000_000 , 
max_messages : 20 
} 
...
10 . times do | i | 
publisher . [ publish_async ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Publisher.html) "This is message # #{ i } ." , 
ordering_key : "ordering-key" 
end 

# Stop the async_publisher to send all queued messages immediately. 
publisher . [ async_publisher ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-pubsub/latest/Google-Cloud-PubSub-Publisher.html) . stop! 
