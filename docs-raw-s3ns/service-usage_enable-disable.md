...
This page describes how to enable and disable services for a Cloud de Confiance project.
You can use Service Usage to enable or disable any available
Cloud de Confiance by S3NS services.

Most users can enable and disable services with the Cloud de Confiance console. For
...
[Go to API Library](https://console.cloud.s3nscloud.fr/apis/library)

- 

Select a recent project or use the resource selector on the console
toolbar to select the Cloud de Confiance project where you want to enable an API.
...
- ` PROJECT_ID `: your Cloud de Confiance by S3NS
project ID.
...
Select a recent project or use the resource selector on the console
toolbar to select the Cloud de Confiance project where you want to disable an API.
