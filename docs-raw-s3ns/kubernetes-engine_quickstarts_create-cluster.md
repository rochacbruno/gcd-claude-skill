...
# Create a cluster and deploy a workload in the Cloud de Confiance console 
...
This tutorial lets you quickly see a running Google Kubernetes Engine cluster and sample workload, all set up using the Cloud de Confiance console. You can then explore the workload in the Cloud de Confiance console before going on to our [more in-depth learning path](/kubernetes-engine/docs/learn/scalable-apps), or to start planning and creating your own production-ready cluster.
...
Visit the
[
Kubernetes Engine page](https://console.cloud.s3nscloud.fr/projectselector/kubernetes) in the Cloud de Confiance console.
...
[Go to Create an Autopilot cluster](https://console.cloud.s3nscloud.fr/kubernetes/auto/add)
...
In the Cloud de Confiance console, go to the GKE **Workloads**
page.

[Go to Workloads](https://console.cloud.s3nscloud.fr/kubernetes/workload/overview)
...
In the Cloud de Confiance console, go to
the **Deployment details** page for **hello-world-app**:

- 

In the Cloud de Confiance console, go to the GKE **Workloads** page.
...
longer need the project, [delete the project](https://console.cloud.s3nscloud.fr/cloud-resource-manager).
...
[Go to Clusters](https://console.cloud.s3nscloud.fr/kubernetes/list/overview)
...
[Go to Logs storage](https://console.cloud.s3nscloud.fr/logs/storage)
...
[Go to Log router](https://console.cloud.s3nscloud.fr/logs/router)
