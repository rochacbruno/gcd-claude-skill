...
Source: https://documentation.s3ns.fr/access-context-manager/docs/reference/rest
...
](https://documentation.s3ns.fr/access-context-manager/docs/apis)
...
An API for setting attribute based access control to requests to Cloud de Confiance services. 
...
- [https://accesscontextmanager.s3nsapis.fr/$discovery/rest?version=v1](https://accesscontextmanager.s3nsapis.fr/$discovery/rest?version=v1)
...
- `https://accesscontextmanager.s3nsapis.fr`
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.CreateAuthorizedOrgsDesc` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.DeleteAuthorizedOrgsDesc` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.GetAuthorizedOrgsDesc` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.ListAuthorizedOrgsDescs` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.UpdateAuthorizedOrgsDesc` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.CreateGcpUserAccessBinding` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.DeleteGcpUserAccessBinding` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.GetGcpUserAccessBinding` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.ListGcpUserAccessBindings` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.UpdateGcpUserAccessBinding` is not available in Cloud de Confiance by S3NS. | 
|
...
The method `google.identity.accesscontextmanager.v1.AccessContextManager.ListSupportedPermissions` is not available in Cloud de Confiance by S3NS. | 
|
