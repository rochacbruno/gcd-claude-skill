...
](https://documentation.s3ns.fr/access-context-manager/docs/resources)
...
[feed URL](https://documentation.s3ns.fr/feeds/access-context-manager-release-notes.xml) directly.
...
[Generally available](https://documentation.s3ns.fr/products/#product-launch-stages): You can now use an internal IP address when specifying an IP address range in basic access levels.

For more information, see [Creating a basic access level](/access-context-manager/docs/create-basic-access-level).