...
- [ Diagnosing Cloud de Confiance console errors ](#trouble-console)
...
to access the Cloud de Confiance console. For the Google Chrome browser:
...
_ , err = client . [ Bucket ](https://documentation.s3ns.fr/go/docs/reference/cloud.google.com/go/storage/latest/index.html#cloud_google_com_go_storage_Client_Bucket) ( "my-bucket" ). Attrs ( ctx ) 
if err != nil { 
// Handle error. 
} 
} 
...
```
import com.google.api.gax.rpc.[FixedHeaderProvider](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.FixedHeaderProvider.html) ; 
import com.google.api.gax.rpc.[HeaderProvider](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.HeaderProvider.html) ; 
import com.google.cloud.[WriteChannel](https://documentation.s3ns.fr/java/docs/reference/google-cloud-core/latest/com.google.cloud.WriteChannel.html) ; 
...
public void main ( [ String ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) args [] ) throws IOException { 
[ HeaderProvider ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.HeaderProvider.html) headerProvider = 
[ FixedHeaderProvider ](https://documentation.s3ns.fr/java/docs/reference/gax/latest/com.google.api.gax.rpc.FixedHeaderProvider.html) . create ( "custom-header" , "custom-value" ); 
[ Storage ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-storage/latest/com.google.cloud.storage.Storage.html) storage = [ StorageOptions ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-storage/latest/com.google.cloud.storage.StorageOptions.html) . getDefaultInstance () 
. toBuilder () 
. setHeaderProvider ( headerProvider ) 
. build (). getService (); 
[ String ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) bucketName = "example-bucket" ; 
[ String ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-bigtable/latest/com.google.cloud.bigtable.common.Type.String.html) blobName = "test-custom-header" ; 

// Use client with custom header 
[ BlobInfo ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-storage/latest/com.google.cloud.storage.BlobInfo.html) blob = [ BlobInfo ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-storage/latest/com.google.cloud.storage.BlobInfo.html) . newBuilder ( bucketName , blobName ). build (); 
byte [] stringBytes ; 
try ( [ WriteChannel ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-core/latest/com.google.cloud.WriteChannel.html) writer = storage . [ writer ](https://documentation.s3ns.fr/java/docs/reference/google-cloud-storage/latest/com.google.cloud.storage.Storage.html#com_google_cloud_storage_Storage_writer_com_google_cloud_storage_BlobInfo_com_google_cloud_storage_Storage_BlobWriteOption____) ( blob )) { 
...
client = [ storage ](https://documentation.s3ns.fr/python/docs/reference/storage/latest) . [ Client ](https://documentation.s3ns.fr/python/docs/reference/storage/latest/google.cloud.storage.client.Client.html) ( 
extra_headers = { 
"x-custom-header" : "value" 
} 
) 
...
[Cloud de Confiance by S3NS resource hierarchy](/resource-manager/docs/cloud-platform-resource-hierarchy) resource that you are enabling
Storage Intelligence on.

- Ensure that a resource higher in the Cloud de Confiance by S3NS resource hierarchy passes the permissions to the child resource.
...
## Diagnosing Cloud de Confiance console errors

**Issue**: When using the Cloud de Confiance console to perform an
...
**Solution**: Use the Cloud de Confiance console's notifications to see detailed
...
(*notifications*)
in the Cloud de Confiance console header.
...
**Issue**: When using the Cloud de Confiance console, I don't see a particular column
displayed.

**Solution**: To see a particular column displayed in the Cloud de Confiance console,
...
contained them doesn't appear in the Cloud de Confiance console.

**Solution**: While the Cloud de Confiance console displays your bucket's contents
...
no longer appears in the Cloud de Confiance console.
...
[Cloud de Confiance by S3NS Service Health Dashboard](https://status.cloud.google.com/summary) provides information about
incidents affecting Cloud de Confiance by S3NS services such as Cloud Storage.
...
`storage.s3nsapis.fr`. Because Google services are exposed using DNS names
