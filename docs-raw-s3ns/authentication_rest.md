...
Enable the Cloud Resource Manager and Identity and Access Management (IAM) APIs, if any are not already enabled:
...
If you are running on a Cloud de Confiance compute resource, you shouldn't
...
service account. For example, `my-sa@my-project.s3ns.iam.gserviceaccount.com`.
...
- 
PROJECT_ID : The ID or name of the Cloud de Confiance by S3NS project to use as a billing project.
