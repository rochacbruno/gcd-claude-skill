...
# Create the client. 
client = Google :: Cloud :: [ Kms ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-kms-inventory/latest/Google-Cloud-Kms.html) . [ key_management_service ](https://documentation.s3ns.fr/ruby/docs/reference/google-cloud-kms/latest/Google-Cloud-Kms.html)
