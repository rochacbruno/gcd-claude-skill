...
Source: https://documentation.s3ns.fr/pubsub/docs/release-notes
...
](https://documentation.s3ns.fr/pubsub/docs/resources)
...
[feed URL](https://documentation.s3ns.fr/feeds/pubsub-release-notes.xml) directly.
...
Pub/Sub is now available in the `northamerica-south1` region (Querétaro, Mexico, North America). For more information, see [Cloud locations](https://documentation.s3ns.fr/about/locations).
