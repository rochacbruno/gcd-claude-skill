...
Source: https://documentation.s3ns.fr/logging/docs/write-query-log-entries-gcloud
...
You must have a Cloud de Confiance project with billing enabled to complete this
quickstart.
If you don't have a Cloud de Confiance project, or if you don't have
billing enabled for your Cloud de Confiance project, then do the following:
...
To view log entries in the Cloud de Confiance console, you can use the
Logs Explorer. Most Cloud de Confiance projects store a large number of logs;
...
Ensure your Cloud de Confiance project is selected in the Cloud de Confiance by S3NS
navigation bar. If necessary, use the Cloud de Confiance project drop-down list
to select your Cloud de Confiance project.
...
the resources used on this page, delete the Cloud de Confiance project with the
resources.
