...
Source: https://documentation.s3ns.fr/docs/quotas/view-ongoing-rollouts
...
This section explains how to view these rollouts from the Cloud de Confiance console
and the Cloud Quotas API.

## Understand ongoing rollouts 

When another Cloud de Confiance by S3NS service increases the default quota values for
