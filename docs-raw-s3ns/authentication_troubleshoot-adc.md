...
Source: https://documentation.s3ns.fr/docs/authentication/troubleshoot-adc
...
There are two kinds of Cloud de Confiance APIs:
...
If you are using the gcloud CLI to access Cloud de Confiance in a
