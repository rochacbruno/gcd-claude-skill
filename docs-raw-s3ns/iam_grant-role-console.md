...
# Grant an IAM role by using the Cloud de Confiance console 




Learn how to use the Cloud de Confiance console to grant
...
[Go to IAM](https://console.cloud.s3nscloud.fr/iam-admin/iam?supportedpurview=project) 
...
Cloud de Confiance console pages by doing the following:
...
If the principal tries to access a different Cloud de Confiance console page that
