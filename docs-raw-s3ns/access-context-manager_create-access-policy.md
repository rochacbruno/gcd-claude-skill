...
Source: https://documentation.s3ns.fr/access-context-manager/docs/create-access-policy
...
is a unique [numeric identifier for the policy](https://documentation.s3ns.fr/access-context-manager/docs/manage-access-policy#get_the_name_of_an_access_policy)
assigned by Cloud de Confiance by S3NS):
...
You must continue to use organization-level policies for Cloud de Confiance by S3NS
...
In the Cloud de Confiance console navigation menu, click **Security**, and then
click **VPC Service Controls**.

[Go to VPC Service Controls](https://console.cloud.s3nscloud.fr/security/service-perimeter) 
