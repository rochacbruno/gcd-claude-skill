...
](https://documentation.s3ns.fr/kubernetes-engine/docs/concepts/machine-learning)
...
[free tier](https://documentation.s3ns.fr/kubernetes-engine/pricing#cluster_management_fee_and_free_tier),
which lets you get started with Kubernetes without incurring costs for cluster
management.

- 

[Get started in Cloud de Confiance console](https://console.cloud.s3nscloud.fr/kubernetes/aiml/overview)
...
- Get AI-powered assistance to plan and design the infrastructure for your GKE clusters by prompting Gemini in the Cloud de Confiance console. For more information, see [Design and optimize your GKE cluster with Gemini](/kubernetes-engine/docs/design-with-gemini).
...
Cloud de Confiance by S3NS offers a spectrum of AI infrastructure products to support your
...
| 
Cloud de Confiance by S3NS service | 
Best for | 
|
...
[View details for your AI/ML workloads in Cloud de Confiance console](https://console.cloud.s3nscloud.fr/kubernetes/aiml), including resources such as JobSets, RayJobs, PyTorchJobs, and Deployments for inference serving.