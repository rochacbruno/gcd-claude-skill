# Best practices when working with Cloud de Confiance resources

Source: https://documentation.s3ns.fr/docs/terraform/best-practices/working-with-resources
...
Best practices for provisioning Cloud de Confiance resources with Terraform, are
...
automatically managed by Cloud de Confiance are removed—potentially disrupting
