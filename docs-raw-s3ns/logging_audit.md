...
and accesses within your Cloud de Confiance resources. Audit logs help you
answer "who did what, where, and when?" within your Cloud de Confiance resources
...
Cloud de Confiance data and systems for possible vulnerabilities or external
data misuse.
...
that can be accessed without logging into a Cloud de Confiance don't
...
Access audit logs to be written for Cloud de Confiance services other than
...
Cloud de Confiance project is charged for the logs storage. You can't disable Policy
...
If you want to route audit log entries for a Cloud de Confiance organization,
