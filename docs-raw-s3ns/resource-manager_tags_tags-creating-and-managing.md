...
Source: https://documentation.s3ns.fr/resource-manager/docs/tags/tags-creating-and-managing
...
that can be attached to a Cloud de Confiance by S3NS resource. You can use tags to
...
Cloud de Confiance by S3NS hierarchy. To create a new tag, you must first create a tag key
...
tag binding to a resource. These are called dynamic tag values([Preview](https://documentation.s3ns.fr/products#product-launch-stages)).
...
Open the **Tags** page in the Cloud de Confiance console.

[Open Tags page](https://console.cloud.s3nscloud.fr/iam-admin/tags) 
...
resource using the Cloud de Confiance console, the gcloud CLI, or with a
call to the API.
...
Cloud de Confiance console, the gcloud CLI, or with a call to the API.
...
resources using the Cloud de Confiance console. See
...
tag can be attached to a Cloud de Confiance by S3NS resource as a key-value pair. Exactly one
...
the value to the Cloud de Confiance by S3NS resource. The following workflow describes how to
...
[Open Manage resources page](https://console.cloud.s3nscloud.fr/cloud-resource-manager) 
...
[Go to Organization policies](https://console.cloud.s3nscloud.fr/iam-admin/orgpolicies) 
...
- **Resource type**: the fully qualified name of the Cloud de Confiance
...
Cloud de Confiance REST resource that you want to enforce mandatory tags on,
...
Cloud de Confiance project, you should omit this flag. If you are
...
Cloud de Confiance console, do the following:

- 

Open the **IAM** page in the Cloud de Confiance console.

[Open IAM page](https://console.cloud.s3nscloud.fr/iam-admin/iam) 
...
System tags are Google-managed tags that Cloud de Confiance by S3NS services can bind to
...
You can browse the Semantic Catalog in the Cloud de Confiance console to view
...
To access the Semantic Catalog using the Cloud de Confiance console, do the
following:
