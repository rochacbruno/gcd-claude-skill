...
Cloud de Confiance. We recommend this option if the following scenarios apply to your organization:
...
organization, or you can switch to using the Google Cloud CLI or the Cloud de Confiance console.
...
Understand the Cloud de Confiance [resource
...
that you are signed in to Cloud de Confiance with your administrator ID.

- You have [set up the Google Cloud CLI](/docs/get-started-tpc/setup-gcloud) for use with Cloud de Confiance.
...
Your [organization resource](/resource-manager/docs/cloud-platform-resource-hierarchy#organizations) ID. You can find this in the Cloud de Confiance console, or by running the following Google Cloud CLI command:
...
Google Cloud CLI or the Cloud de Confiance console that your folder and project structure
...
simple example up and running on Cloud de Confiance. Find out more in [What's next](#whats_next).
