...
Source: https://documentation.s3ns.fr/docs/quotas/configure-vpc-service-controls
...
Cloud de Confiance by S3NS Virtual Private Cloud (VPC) Service Controls lets you set up a
...
add [other Cloud de Confiance by S3NS APIs to the VPC service
