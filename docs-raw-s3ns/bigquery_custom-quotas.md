...
Source: https://documentation.s3ns.fr/bigquery/docs/custom-quotas
...
the
[Quotas page](https://console.cloud.s3nscloud.fr/iam-admin/quotas?metric=bigquery.googleapis.com%2Fquota%2Fquery%2Fusage).
...
[on-demand query pricing model](https://documentation.s3ns.fr/bigquery/pricing#on_demand_pricing).
...
displayed on the **Quotas & System Limits** page of the Cloud de Confiance console. When
