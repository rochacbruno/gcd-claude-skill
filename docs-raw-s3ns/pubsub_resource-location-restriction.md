...
Source: https://documentation.s3ns.fr/pubsub/docs/resource-location-restriction
...
Cloud de Confiance by S3NS region. If you want to control the regions in which your
...
Cloud de Confiance by S3NS regions that you specify, regardless of where the publish or
...
to where the published message enters the Cloud de Confiance network.
...
If a client runs within Cloud de Confiance in one of the allowed regions
...
If a client runs within Cloud de Confiance in a region that isn't allowed,
or runs outside of Cloud de Confiance, it must use a locational or regional
...
The policy specifies a list of allowed Cloud de Confiance region names. As
...
[Go to Organization policies](https://console.cloud.s3nscloud.fr/iam-admin/orgpolicies/list?project=_&%0Aservice=pubsub.googleapis.com) 
...
Click **Cloud de Confiance by S3NS - Resource Location Restriction**.
...
For more information about organization policies, see [Manage your Cloud de Confiance by S3NS resources](/resource-manager/docs/manage-google-cloud-resources).
...
When using the Cloud de Confiance console, you can't configure a message storage policy
...
supported Cloud de Confiance regions.
...
In the Cloud de Confiance console, open the **Topic details** page.

[Go to Topic details](https://console.cloud.s3nscloud.fr/cloudpubsub/topicList) 
...
The Cloud de Confiance console displays any differences between the
...
[Go to Pub/Sub](https://console.cloud.s3nscloud.fr/cloudpubsub/topicList) 
...
offers metrics broken down by each Cloud de Confiance region.
...
outside Cloud de Confiance or in regions not allowed by the policy. Users who
...
Cloud de Confiance are, as a rule, bound to the Pub/Sub
...
When publishing from outside of Cloud de Confiance by S3NS, an additional layer of routing is
involved to get the request to a nearby Cloud de Confiance by S3NS region where the
